...
var ROLES = [
  ...
  {r:'Biostatistician',                        lv:'10', sal:69852},
  ...
  {r:'PhD student',                            lv:'—',  sal:29731},
  {r:'Masters student',                        lv:'—',  sal:28231},
  {r:'Summer student',                         lv:'—',  sal:29000}
];

// Source: docs/public/cim-rates.csv — update that file, then regenerate this array
// Columns: Non-Industry = CIM Col D (PI-initiated, not pharma-funded)
//          Industry     = CIM Col E (includes pharma-funded PI studies)
// Equipment Rental Only (Col C) is excluded — not applicable for grant submissions
// Last updated: 2026-05-12
var SVC_CIM_DATA = [
  {label:"ELECTROCARDIOGRAM",group:"platform",items:[["Supine 12-lead resting ECG - no physician interpretation",38.0,80.0]]},
  {label:"VITAL SIGNS",group:"platform",items:[["Heart rate, blood pressure, SpO2, breathing frequency, temperature",20.0,30.0],["Arterial stiffness - AtCor SphygmoCor XCEL et CvMS",82.0,200.0],["Blood perfusion and tcpO2/tcpCO2- Perimed PeriFlux 5000 doppler laser",82.0,200.0],["Flow-mediated dilation measures by ultrasound (coming soon)",122.0,250.0]]},
  {label:"NON-INVASIVE VASCULAR ASSESSMENTS",group:"platform",items:[["Retial vascular assessment- IMEDOS Static Vascular Analysis",82.0,200.0],["Ankle-brachial blood pressure index- Huntleigh Dopplex",60.0,100.0],["24-hours blood pressure monitoring- Mobil-O-Graph PWA",60.0,75.0],["Spirometry - pre bronchodilator",43.0,90.0],["Add on spirometry - post bronchodilator",43.0,80.0],["Lung volumes by body plethysmography",43.0,90.0],["Lung diffusion capacity (DLCO)",43.0,90.0],["Complete pulmonary function testing (PFT)",129.0,235.0],["Airway resistance and impulse oscilometry",32.0,45.0]]},
  {label:"PULMONARY FUNCTION TEST",group:"platform",items:[["Maximal inspiratory and expiratory pressures (MIP&MEP)",32.0,45.0],["Maximal voluntary ventilation (MVV)",32.0,45.0],["Multiple breath washout",80.0,150.0],["Aerochamber",6.0,8.0],["Other (e.g. FeNO, nasal peak flow, holter, travel time) hourly rate",61.0,82.0],["6-min walk test",60.0,170.0],["Sit to stand test",15.0,30.0],["4-square step test",15.0,30.0],["Bailey-III screening test for infant and toddler development",60.0,300.0],["Performance of upper limb (PUL) test",60.0,100.0],["Short Physical Performance Battery (SPPB)",60.0,82.0],["Hand grip strenght test",15.0,40.0],["Cardio-pulmonary exercise test (CPET) with cycle ergometer",212.0,354.0]]},
  {label:"FUNCTIONAL TEST and EXERCISE PHYSIOLOGY",group:"platform",items:[["Cardio-pulmonary exercise test (CPET) with treadmill",212.0,354.0],["Isokinetic cycle ergometer",29.0,64.0],["Resting energy expenditure",212.0,354.0],["Exercise training equipment (per training session)",null,null],["Other (travel time) hourly rate",61.0,82.0],["Other (start-up, training) hourly rate",61.0,82.0],["Other (inspiratory capacity data cleaning, data analysis) hourly rate",61.0,82.0],["Other (questionnaires, data transfer) hourly rate",61.0,82.0]]},
  {label:"BIOELECTRICAL IMPEDANCE ANALYSIS (InBody570)",group:"platform",items:[["BIA total body composition",26.0,45.0],["DXA femur bone density",94.0,138.0],["DXA forearm bone density",94.0,138.0]]},
  {label:"DUAL X-RAY ABSORPTIOMETRY",group:"platform",items:[["DXA spine bone density",94.0,138.0],["DXA total body composition",94.0,138.0],["DXA phantom",94.0,138.0],["pQCT tibia",94.0,138.0]]},
  {label:"PERIPHERAL QUANTITATIVE COMPUTED TOMOGRAPHY (pQCT)",group:"platform",items:[["pQCT femur",94.0,138.0],["pQCT radius",94.0,138.0]]},
  {label:"MAGNETIC RESONANCE IMAGING (MRI)",group:"platform",items:[["Head -",550.0,1300.0],["Head +",675.0,1450.0],["Technical assistance",65.0,85.0],["Head -",328.0,475.0],["Head +",385.0,575.0],["Neck -",328.0,475.0],["Neck +",385.0,575.0],["Chest -",328.0,550.0],["Chest +",385.0,650.0],["Abdomen -",328.0,550.0],["Abdomen +",385.0,650.0],["Pelvis -",328.0,550.0],["Pelvis +",385.0,650.0],["Chest/abdomen -",504.0,700.0],["Chest/abdomen +",562.0,800.0],["Chest/abdomen-pelvis -",504.0,950.0],["Chest/abdomen-pelvis +",562.0,1050.0]]},
  {label:"COMPUTERIZED TOMOGRAPHY (CT) SCAN",group:"platform",items:[["Abdomen-pelvis -",390.0,700.0],["Abdomen-pelvis +",447.0,800.0],["Neck/chest/abdomen -",603.0,1150.0],["Neck/chest/abdomen +",660.0,1250.0],["Neck/chest/abdomen-pelvis -",603.0,1375.0],["Neck/chest/abdomen-pelvis +",660.0,1575.0],["Upper or lower extremity -",328.0,425.0],["Upper or lower extremity +",385.0,525.0],["Spine (each segment) -",328.0,400.0],["Spine (each segment) +",385.0,500.0],["Extra charge - multiphase CT",104.0,160.0],["Other (e.g. anonymization and upload of images) hourly rate",59.0,79.0],["DICOM image copy on a CD",13.0,14.0],["Study start-up fee",520.0,788.0],["Only radiologist reading fee - per body area",156.0,156.0],["Blood draw - above 9 years old - vacutainers not included",14.0,26.0],["Blood draw - above 9 years old - vacutainers included",19.0,31.0],["Blood draw - below 9 years old - vacutainers not included",19.0,31.0],["Blood draw - below 9 years old - vacutainers included",23.0,35.0],["Extra charge - blood draw for venous blood gas",14.0,19.0],["Extra charge - blood draw from IV line",2.0,3.0]]},
  {label:"SPECIMEN COLLECTION",group:"platform",items:[["Extra charge - IV catheter insertion",9.0,12.0],["Phlebotomy kit preparation (each)",5.0,8.0],["Nasopharyngeal swabs",19.0,31.0],["Urine collection",13.0,18.0],["Urine rapid test- kit not included (such as pregnancy or pH)",19.0,26.0],["Dry ice",41.0,47.0],["Specimen processing hourly rate",55.0,72.0],["Specimen shipping services hourly rate",55.0,72.0],["Ambiant shipping",27.5,36.0]]},
  {label:"SPECIMEN PROCESSING AND SHIPPING",group:"platform",items:[["Frozen shipping (dry ice sold separately)",27.5,36.0],["Refrigerated shipping",27.5,36.0],["Combo shipping (dry ice sold separately)",41.25,54.0],["Other (travel time) hourly rate",55.0,72.0],["Other (start-up, training) hourly rate",55.0,72.0]]},
  {label:"SLEEP LAB",group:"platform",items:[["Other (e.g. PSG analysis, data transfer) hourly rate",61.0,82.0]]},
  {label:"BRONCHOSCOPY / GASTROSCOPY / ENDOSCOPY",group:"platform",items:[["Bronchoscopy, Gastroscopy or Endoscopy",645.0,840.0],["Other (e.g. patient monitoring) hourly rate",59.0,79.0]]},
  {label:"OPERATING ROOM",group:"platform",items:[["14- Echocardiogram ultrasound machine (per exam)",61.0,null],["24- Data management",69.0,null],["3 - Add on charge for simple transthoracic echocardiogram image acquisition by technologist",114.0,null]]},
  {label:"CARDIAC ECHO",group:"platform",items:[["7 - Add on charge for report simple echo measures",152.0,null],["9 - Add on charge for image upload",44.0,null],["10 - Add on charge for a copy of an exam on an external media (DVD, CD, USB key)",18.0,null],["11 - If needed, technical assistance (hourly rate)",110.0,null],["12 - If needed, manual anonymization of images (hourly rate)",110.0,null],["13 - If needed, training, start up activities, other (houly rate)",110.0,null],["Ethics submissions - Lead or single site",1350.0,null],["Ethics submission - Particpating site",785.0,null]]},
  {label:"SUBMISSION SERVICES",group:"support",items:[["Annual renewal",395.0,null],["Negotiations of start up budget (1-2 arms)",830.0,null],["Negotiations of start up budget (3 plus)",1350.0,null]]},
  {label:"BUDGET SERVICES",group:"support",items:[["Nurse",85.0,null]]},
  {label:"TRIAL CONDUCT RESOURCES",group:"support",items:[["Coordinator",75.0,null],["Monitor",62.0,null],["Project Manager",70.0,null]]}
];
...
var ACT_GROUPS = [
  ...
  {label:'Per Participant — Visit Activities', cls:'perpt-grp', type:'perpt', items:['Visit Preparations','Recruitment and consent','Chart Review','Eligibility screening','Medical History and Demographic Data Collection','Full Physical Examination (vital signs, weight, height)','Recording of Concomitant Medications','Blood Collection','Specimen Collection','Study Product Administration and Accountability','Adverse event review and reporting','Data Entry (per visit)','CRF Completion (per visit)']},
...
var TEMPLATES = {
  ...
  'iit': {
    funding: 'iit',
    startup: ['Protocol development and writing','REB initial submission','DSMB establishment and first meeting','Grant application preparation','Quebec public trial registry submission','Study staff training'],
  ...
  'obs': {
    funding: null,
    startup: ['Protocol and statistical analysis plan','REB initial submission','Recruitment strategy and materials','Database build (REDCap or equivalent)'],
  ...
  'chart': {
    funding: null,
    startup: ['REB initial submission','Data access agreement with medical records','Case identification query (EMR/OACIS)','Data extraction template development'],
  ...
  'phase1': {
    funding: 'ind',
    startup: ['Protocol development (Phase I dose escalation)','IND/CTA submission to Health Canada','REB initial submission','Pharmacy — IP preparation protocol and validation','Safety Review Committee establishment','DSMB charter','Site initiation visit — preparation','Quebec public trial registry','Staff GCP training (refresher)'],
...
function selectFunding(type) {
  ...
  if (type === 'iit') {
    var iitPct = parseFloat(document.getElementById('iit-oh-pct') ? document.getElementById('iit-oh-pct').value : 0) || 0;
    oh = iitPct / 100;
  } else if (type === 'found') {
...
function updateIITOH() {
  if (funding === 'iit') {
    var iitPctEl = document.getElementById('iit-oh-pct');
    var pct = iitPctEl ? (parseFloat(iitPctEl.value) || 0) : 0;
    oh = pct / 100;
    updateSummary();
  }
}
...
function applyTemplate(tplId) {
  if (Object.keys(matrixData).length > 0) {
    if (!confirm('Applying a template will reset the Work Plan. Continue?')) return;
  }
...
function updateEquipSub() {
  var inp = document.getElementById('equip-cost');
  var sub = document.getElementById('equip-cost-sub');
  if (inp && sub) sub.textContent = '$' + Math.round(parseFloat(inp.value) || 0).toLocaleString();
  updateSummary();
}

function getEquipCost() {
  var el = document.getElementById('equip-cost');
...
// LAB PRICELIST
// ════════════════════════════════════════
function getLabPrice(priceNI, priceI) {
  // found → ×1.1 researcher-funded; iit → ×1.5 CIHR-sponsored; ind → ×2.0 pharmaceutical (×1.5 × 4/3)
  if (funding === 'ind') return priceI > 0 ? Math.round(priceI * 4 / 3 * 100) / 100 : 0;
  if (funding === 'iit') return priceI;
  return priceNI;
}
...
function renderLab() {
  ...
  for (var i = 0; i < LAB_DATA.length; i++) {
    ...
    var price  = getLabPrice(priceNI, priceI);
...
function refreshSimpleSubs() {
  var pairs = [
    ...
    ['imp-cost',      'imp-cost-sub'],
    ['insure-cost',   'insure-cost-sub'],
    ['closeout-cost', 'closeout-cost-sub'],
    ['profsvc-cost',  'profsvc-cost-sub']
  ];
...
function updateCIHR(staffAmt, svcAmt, contAmt, travelAmt, otherAmt, ptAmt) {
  ...
  var impVal      = parseFloat((document.getElementById('imp-cost')        || {}).value) || 0;
  var insureVal   = parseFloat((document.getElementById('insure-cost')     || {}).value) || 0;
  var closeoutVal = parseFloat((document.getElementById('closeout-cost')   || {}).value) || 0;
  var profSvcVal  = parseFloat((document.getElementById('profsvc-cost')    || {}).value) || 0;
  var matsup    = getCIMLabTotal() + sfCostVal + redcapVal + transVal + recruitVal + swOtherVal + impVal;
  var equip     = getEquipCost();
  ...
  var other     = contAmt + travelAmt + customOther + (ptAmt || 0) + insureVal + closeoutVal + profSvcVal;
  var total     = personnel + matsup + equip + kt + other;
...
function addSelectedActivities() {
  ...
  if (customName) {
    var customTypeEl = document.getElementById('ap-custom-type');
    var customType = customTypeEl ? customTypeEl.value : (actPickerTypeFilter || 'general');
...
function getBudgetState() {
  ...
  var setupIds = ['study-title','study-protocol','study-years','study-n','study-sites','study-type','multiyear','found-oh-pct','iit-oh-pct'];
  state.setup = {};
  ...
  state.sfCalc = {
    rate: document.getElementById('sf-rate')    ? document.getElementById('sf-rate').value    : '',
    ppCost: document.getElementById('sf-pp-cost') ? document.getElementById('sf-pp-cost').value : ''
  };
...
function setBudgetState(state) {
  ...
  if (state.setup) {
    ...
    if (state.setup['iit-oh-pct'] !== undefined) {
      var iohEl = document.getElementById('iit-oh-pct');
      if (iohEl) iohEl.value = state.setup['iit-oh-pct'];
    }
  }
  ...
  if (state.sfCalc) {
    var srEl = document.getElementById('sf-rate');    if (srEl && state.sfCalc.rate   !== undefined) srEl.value = state.sfCalc.rate;
    var scEl = document.getElementById('sf-pp-cost'); if (scEl && state.sfCalc.ppCost !== undefined) scEl.value = state.sfCalc.ppCost;
  }
...
function exportCSV() {
  ...
  if (impCostVal > 0)    lines += row(['Investigational product (IMP)', fmt(impCostVal)]);
  if (equipCostVal > 0)  lines += row(['Equipment & non-consumables', fmt(equipCostVal)]);
  if (insureCostVal > 0) lines += row(['Study insurance', fmt(insureCostVal)]);
  if (closeoutVal > 0)   lines += row(['Study closeout', fmt(closeoutVal)]);
  if (profSvcVal > 0)    lines += row(['Professional services (CRO, adjudication, central lab)', fmt(profSvcVal)]);
  var otherRows = document.querySelectorAll('#other-list .other-row');
  var hasCustom = false;
  ...
  // Consumables include CIM/Lab + REDCap + translation + recruitment + screening failures + other SW + IMP
  ...
  var customOtherAmt2 = customOtherAmt;
  var cihrOther      = csvCont + csvTravel + csvPt + customOtherAmt2 + insureCostVal + closeoutVal + profSvcVal;
  var cihrTotal      = cihrPersonnel + cihrConsumab + cihrEquip + cihrKT + cihrOther;
  ...
  lines += row(['Consumables', 'CIM + lab + REDCap + translation + recruitment + screening failures + other software + IMP', fmt(cihrConsumab)]);
  lines += row(['Non-consumables', 'Equipment owned by research team', fmt(cihrEquip)]);
  lines += row(['Knowledge Translation', 'KT costs + patient partners', fmt(cihrKT)]);
  lines += row(['Other', 'Participant costs + operational travel + contingency + insurance + closeout + professional services + custom other rows', fmt(cihrOther)]);
...
function btInit() {
  ...
  // Double rAF: ensures updateSummary runs after Mintlify's React render cycle resets the DOM.
  requestAnimationFrame(function() {
    requestAnimationFrame(function() { calcREB(); updateSummary(); });
  });
