...
- **Volunteers** — may perform administrative and non-participant-facing tasks (filing, de-identified data entry, logistics) when added to the Task Delegation Log, but cannot interact with participants or be listed on protocols. See [Volunteering on a Research Team](/kb/roles/onboarding-volunteers).
...
Students covered by academic insurance may participate, including participant interaction, provided they meet training requirements. See [Joining a Research Team as a Trainee](/kb/roles/onboarding-trainees).
...
<CardGroup cols={3}>
  <Card title="Investigator (PI/QI)" icon="user-doctor" href="/kb/roles/pi-pathway">
    Privileges, study leadership, delegation, and accountability across the study lifecycle.
  </Card>
  <Card title="Clinical Research Coordinator" icon="clipboard-list" href="/kb/roles/crc-guide">
    Day-to-day coordination for interventional studies — startup through close-out.
  </Card>
  <Card title="Research Nurse" icon="heart-pulse" href="/kb/roles/nurse-guide">
    Clinical procedures, participant safety, delegation scope, and CIM nursing specifics.
  </Card>
  <Card title="Student or Trainee" icon="graduation-cap" href="/kb/roles/onboarding-trainees">
    What trainees can be delegated, fellows and resident rules, and onboarding steps.
  </Card>
  <Card title="Volunteer" icon="hands-helping" href="/kb/roles/onboarding-volunteers">
    Permitted tasks, what volunteers cannot do, and the TDL requirements.
  </Card>
  <Card title="Observer" icon="eye" href="/kb/roles/onboarding-observers">
    Site visit rules, confidentiality obligations, and international visitor requirements.
  </Card>
</CardGroup>
