...
Color legend: **navy** = SOP Reader (universal), **teal** = Competency Assessment (universal, different renewal cycle), **amber** = ICH GCP, **coral** = Health Canada Division 5 (Level I only), **purple** = ISO 14155 (Level II only).
