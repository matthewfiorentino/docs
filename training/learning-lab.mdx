...
/* ── Continue widget ─────────────────────────────────────────────────── */
.ll-continue { margin: 4px 0 28px; }
.ll-continue-head {
  display: flex; align-items: center; gap: 6px;
  font-size: 11px; font-weight: 700; letter-spacing: .12em; text-transform: uppercase;
  color: var(--ll-text-3); margin-bottom: 10px;
}
.ll-continue-head::before {
...
.ll-continue-list { display: flex; flex-direction: column; gap: 6px; }
.ll-continue-item {
  display: flex; align-items: center; gap: 12px;
  padding: 12px 14px; border: 1px solid var(--ll-bdr); border-radius: 10px;
  background: var(--ll-bg); cursor: pointer; font: inherit; text-align: left; width: 100%;
  transition: border-color .15s, background .15s;
}
.ll-continue-item:hover { border-color: var(--ll-accent); background: var(--ll-accent-soft); }
.ll-continue-icon { flex-shrink: 0; width: 18px; height: 18px; stroke: var(--ll-text-2); fill: none; stroke-width: 1.7; stroke-linecap: round; stroke-linejoin: round; }
.ll-continue-meta { display: flex; flex-direction: column; flex: 1; min-width: 0; }
.ll-continue-kind { font-size: 10.5px; font-weight: 700; letter-spacing: .1em; text-transform: uppercase; color: var(--ll-text-3); margin-bottom: 2px; }
.ll-continue-title { font-size: 13.5px; color: var(--ll-text); line-height: 1.4; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.ll-continue-when { font-size: 11.5px; color: var(--ll-text-3); flex-shrink: 0; }

/* ── Saved-items widget (Overview) ───────────────────────────────────── */
.ll-saved { margin: 0 0 28px; }
.ll-saved-head {
  display: flex; align-items: center; gap: 6px;
  font-size: 11px; font-weight: 700; letter-spacing: .12em; text-transform: uppercase;
  color: var(--ll-text-3); margin-bottom: 10px;
}
.ll-saved-list { display: flex; flex-direction: column; gap: 6px; }
.ll-saved-item {
  display: flex; align-items: center; gap: 12px;
  padding: 12px 14px; border: 1px solid var(--ll-bdr); border-radius: 10px;
  background: var(--ll-bg); cursor: pointer; font: inherit; text-align: left; width: 100%;
...
.ll-saved-item:hover { border-color: var(--ll-accent); background: var(--ll-accent-soft); }
.ll-saved-icon { flex-shrink: 0; width: 18px; height: 18px; stroke: var(--ll-text-2); fill: none; stroke-width: 1.7; stroke-linecap: round; stroke-linejoin: round; }
.ll-saved-meta { display: flex; flex-direction: column; flex: 1; min-width: 0; }
.ll-saved-kind { font-size: 10.5px; font-weight: 700; letter-spacing: .1em; text-transform: uppercase; color: var(--ll-text-3); margin-bottom: 2px; }
.ll-saved-title { font-size: 13.5px; color: var(--ll-text); line-height: 1.4; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.ll-saved-remove {
  font-size: 18px; line-height: 1; color: var(--ll-text-3); padding: 0 6px;
  flex-shrink: 0; transition: color .15s;
}
.ll-saved-remove:hover { color: #b05555; }

/* ── Save (bookmark) star button ─────────────────────────────────────── */
.ll-save-btn {
  margin-left: auto;
  display: inline-flex; align-items: center; justify-content: center;
  width: 32px; height: 32px;
  background: none; border: 1px solid var(--ll-bdr); border-radius: 8px;
  cursor: pointer; transition: border-color .15s, background .15s;
}
.ll-save-btn svg {
  width: 15px; height: 15px;
  fill: none; stroke: var(--ll-text-3);
  stroke-width: 1.8; stroke-linecap: round; stroke-linejoin: round;
  transition: fill .15s, stroke .15s;
}
.ll-save-btn:hover { border-color: var(--ll-accent); }
.ll-save-btn:hover svg { stroke: var(--ll-accent); }
.ll-save-btn.saved { border-color: var(--ll-accent); background: var(--ll-accent-soft); }
.ll-save-btn.saved svg { fill: var(--ll-accent); stroke: var(--ll-accent); }
...
/* Track detail view */
.ll-track-meta { font-size: 12px; color: var(--ll-text-3); margin: -8px 0 14px; }
.ll-track-progress {
  position: relative; height: 4px; background: var(--ll-bdr); border-radius: 2px; overflow: hidden;
  margin: 0 0 4px;
}
.ll-track-progress-bar { position: absolute; left: 0; top: 0; bottom: 0; background: var(--ll-accent); transition: width .25s; }
.ll-track-progress-label { font-size: 11.5px; color: var(--ll-text-3); margin-bottom: 14px; }
...
.ll-track-step.done   { opacity: .65; }
.ll-track-step.done .ll-track-step-num { background: var(--ll-accent); color: #fff; border-color: var(--ll-accent); }
.ll-track-step.current { border-color: var(--ll-accent); background: var(--ll-accent-soft); }
.ll-track-step-num {
...
<div class="ll">
  <nav class="ll-topnav" aria-label="Learning Lab">
    ...
    <div class="ll-topnav-note">Progress saved on this device.</div>
  </nav>
