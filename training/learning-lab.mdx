...
.ll-topic-card-title { font-size: 15.5px; font-weight: 700; color: var(--ll-text); letter-spacing: -.005em; margin-bottom: 6px; }
.ll-topic-card-desc { font-size: 12px; color: var(--ll-text-3); line-height: 1.5; }
