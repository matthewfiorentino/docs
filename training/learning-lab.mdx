...
.ll-about-hero {
  ...
  background:
    radial-gradient(ellipse 70% 100% at 0% 50%,  rgba(43,156,226,0.18) 0%, transparent 70%),
    radial-gradient(ellipse 50% 80%  at 100% 0%,  rgba(144,57,249,0.14) 0%, transparent 65%),
    radial-gradient(ellipse 55% 70%  at 90% 100%, rgba(255,83,127,0.16) 0%, transparent 65%),
    #ffffff;
  border-bottom: 1px solid var(--ll-bdr);
}
.ll-about-hero h1 { font-size: 22px; font-weight: 700; color: var(--ll-text); margin: 0 0 8px; }
.ll-about-hero p  { font-size: 14px; color: var(--ll-text-2); margin: 0; line-height: 1.6; max-width: 580px; }
.ll-about-grid {
  display: grid;
...
.ll-about-card:hover { box-shadow: 0 4px 16px rgba(0,0,0,0.10); transform: translateY(-2px); }
.ll-about-icon-wrap {
  width: 48px; height: 48px; border-radius: 12px;
  display: flex; align-items: center; justify-content: center;
  margin-bottom: 14px;
}
.ll-about-icon-wrap svg { width: 24px; height: 24px; fill: none; stroke-width: 1.5; stroke-linecap: round; stroke-linejoin: round; }
.ll-about-card-name  { font-size: 15px; font-weight: 600; color: var(--ll-text); margin-bottom: 6px; }
.ll-about-card-badge { display: inline-block; font-size: 11.5px; color: var(--ll-text-3); background: #f4f4f4; border-radius: 20px; padding: 2px 10px; margin-bottom: 10px; }
.ll-about-card-desc  { font-size: 13.5px; color: var(--ll-text-2); line-height: 1.55; }
