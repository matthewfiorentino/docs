...
/* ── Library page topic-section "Open topic" link ────────────────────── */
.ll-topic-section-link {
  margin-left: auto;
  background: none; border: none; padding: 4px 8px;
  cursor: pointer; font: inherit; font-size: 12px; color: var(--ll-text-3);
  transition: color .15s;
}
.ll-topic-section-link:hover { color: var(--ll-accent); }

/* ── Browse-by-topic chip strip (Overview) ───────────────────────────── */
...
<div class="ll">
  <nav class="ll-topnav" aria-label="Learning Lab">
    ...
    <div class="ll-topnav-note">Practice surface — no login, no tracking.</div>
  </nav>
