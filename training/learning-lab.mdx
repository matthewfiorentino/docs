...
.kp-stage { max-width: 1200px; margin: 0 auto; padding: 16px 32px 100px; min-height: 560px; }
...
.te-questions { margin: 0; padding: 0; list-style: none; }
.te-question { border-top: 1px solid var(--bdr-soft); }
.te-q-text { font-size: 14px; color: var(--text); line-height: 1.7; padding: 18px 24px; }
...
<div class="kp-stage">
  ...
  <!-- ══ PHASE 0: Landing — three pathways ══ -->
  ...
  <!-- ══ PHASE count: How many questions? (Shuffle only) ══ -->
  ...
  <!-- ══ PHASE 1: Topic grid (Browse only) ══ -->
  ...
  <!-- ══ PHASE team-hub: Team Exercises topic picker ══ -->
    ...
    <div class="kp-dr-hub-grid">
      ...
      <div class="kp-dr-hub-card active" onclick="kpStartTeamExercise('delegation')">
        ...
        <div class="kp-dr-hub-meta">
          <span class="kp-dr-hub-count">4 situations · SOP-CR-002</span>
      ...
      <div class="kp-dr-hub-card active" onclick="kpStartTeamExercise('consent')">
        ...
        <div class="kp-dr-hub-meta">
          <span class="kp-dr-hub-count">4 situations · SOP-CR-008</span>
          <span class="kp-dr-hub-cta">Open →</span>
        </div>
      </div>
      ...
      <div class="kp-dr-hub-card active" onclick="kpStartTeamExercise('sae')">
        ...
        <div class="kp-dr-hub-meta">
          <span class="kp-dr-hub-count">4 situations &middot; SOP-CR-012</span>
  ...
  <!-- ══ PHASE te-delegation: Team Exercise ══ -->
...
<li class="te-question">
  ...
  <div class="te-sources"><strong>Sources:</strong> ICH E6(R3) (effective April 1, 2026) &middot; GUI-0100 (updated March 2026) &middot; Health Canada Division 5 C.05.010, C.05.012 &middot; SOP-CR-002 v.09 &middot; Civil Code of Quebec</div>

  </div>

  <!-- ══ PHASE te-consent: Team Exercise ══ -->
  ...
  <div class="te-sources"><strong>Sources:</strong> TCPS2 (2022), Chapters 3 and 11 &middot; Civil Code of Quebec, Articles 20, 21, 24 &middot; ICH E6(R3) &sect;2.8&ndash;2.9 (effective April 1, 2026) &middot; Health Canada Division 5, C.05.010(h) &middot; Loi 25 / EFVP framework &middot; SOP-CR-008 v.08</div>
  </div>

  <!-- ══ PHASE te-sae: Team Exercise ══ -->
    ...
    <ul class="te-questions">
      <li class="te-question">
        ...
        <div class="te-kp-body">
          ...
          <span class="te-kp-ref">ICH E6(R3) &sect;2.7.2 &middot; SOP-CR-012 &middot; Protocol-specific timelines</span>
        </div>
      </li>
      <li class="te-question">
        ...
        <div class="te-kp-body">
          ...
          <span class="te-kp-ref">ICH E2A &middot; C.05.014 &middot; SOP-CR-012</span>
        </div>
      </li>
    </ul>
  </div>
  ...
  <div class="te-sources"><strong>Sources:</strong> ICH E6(R3) &sect;2.7.2 (effective April 1, 2026) &middot; ICH E2A (adverse event definitions and reporting) &middot; Health Canada Division 5 C.05.001, C.05.014 &middot; SOP-CR-012 v.08 &middot; TCPS2 (2022) Art. 11.7&ndash;11.9 &middot; ALCOA+ data integrity principles</div>
  </div>

  <!-- ══ PHASE te-deviations: Team Exercise ══ -->
    ...
    <ul class="te-questions">
      <li class="te-question">
        ...
        <div class="te-kp-body">
          ...
          <span class="te-kp-ref">ICH E6(R3) &sect;2.5.2, &sect;2.7.2 &middot; C.05.010 &middot; SOP-CR-012</span>
        </div>
      </li>
    </ul>
  </div>
  ...
  <!-- ══ PHASE te-monitoring: Team Exercise ══ -->
...
`;
const LL_HTML_2 = `  <div class="te-block">
    <ul class="te-questions">
  ...
  <!-- ══ PHASE te-recruitment: Team Exercise ══ -->
  ...
  <!-- ══ PHASE docreview-hubment Review topic picker ══ -->
  <div class="kp-phase" id="kp-phase-docreview-hub">
    ...
    <div class="kp-dr-hub-grid">
      ...
      <div class="kp-dr-hub-card active" onclick="kpStartDocReview('delegation')">
        ...
        <div class="kp-dr-hub-meta">
          <span class="kp-dr-hub-count">6 findings &middot; SOP-CR-002</span>
      ...
      <div class="kp-dr-hub-card active" onclick="kpStartDocReview('consent')">
        ...
        <div class="kp-dr-hub-meta">
          <span class="kp-dr-hub-count">6 findings &middot; SOP-CR-008</span>
          <span class="kp-dr-hub-cta">Start &rarr;</span>
        </div>
      </div>
      ...
      <div class="kp-dr-hub-card active" onclick="kpStartDocReview('sae')">
        ...
        <div class="kp-dr-hub-meta">
          <span class="kp-dr-hub-count">5 errors + 1 flag &middot; SOP-CR-012</span>
          <span class="kp-dr-hub-cta">Start &rarr;</span>
        </div>
      </div>
  ...
  <!-- ══ PHASE docreview: Individual exercise ══ -->
  <div class="kp-phase" id="kp-phase-docreview">
    ...
    </div><!-- /kp-dr-delegation-wrap -->

    <!-- Consent form exercise (hidden until consent exercise selected) -->
  ...
  <!-- ══ PHASE jc-hub: Judgement Calls role picker ══ -->
  ...
  <!-- ══ PHASE jc-role: Scenarios for a specific role ══ -->
  ...
  <!-- ══ PHASE jc-scenario: Active judgement call ══ -->
  ...
  <!-- ══ PHASE insp-hub: Inspection Prep topic picker ══ -->
  ...
  <!-- ══ PHASE insp-practice: Active inspection session ══ -->
...
`;
const LL_JS_2 = `    ref:'<a href="SOP-CR-008-overview.html">SOP-CR-008 \u00a75.3.1</a>' },
...
`;
const LL_JS_3 = `    gap:'"The CRC handled it and the PI reviewed and signed everything when she got back" confirms the finding rather than resolving it. Retrospective PI signatures on documents from a period when the PI was demonstrably away is a major inspection finding.',
  ...
  'delegation': {
    ...
    findings: [
      ...
      { type:'error', who:'Patrick Chen',
        ...
        ref:'ICH E6(R3) §2.3.3 · C.05.012' },
`;
const LL_JS_4 = `      { type:'error', who:'Kevin Tremblay',
...
export const LearningLab = () => {
  useEffect(() => {
    ...
    script.id = 'll-script';
    script.textContent = LL_JS_1 + LL_JS_2 + LL_JS_3 + LL_JS_4 + LL_JS_5 + LL_JS_6;
