...
.ll-session-card-head { display: flex; align-items: center; justify-content: space-between; gap: 10px; }
...
.ll-session-card-aud { font-size: 11.5px; color: var(--ll-text-3); flex: 1; text-align: right; line-height: 1.3; }
...
.ll-topic-card-count { font-size: 13px; font-weight: 700; color: var(--ll-accent); flex-shrink: 0; }
...
.ll-track-card-head { display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px; gap: 8px; }
.ll-track-pill {
  font-size: 10px; font-weight: 700; letter-spacing: .08em; text-transform: uppercase;
  color: var(--ll-text-2); padding: 3px 9px; border: 1px solid var(--ll-bdr); border-radius: 999px;
  background: var(--ll-bg);
}
.ll-track-pill-team { color: var(--ll-accent); border-color: var(--ll-accent); background: var(--ll-accent-soft); }
.ll-track-card-dur { font-size: 11.5px; color: var(--ll-text-3); font-weight: 600; }
