...
/* DR: findings panel sticks to pane bottom so table + finding are both visible */
#ll-pane .kp-dr-findings.visible {
  position: sticky;
  bottom: 0;
  background: var(--ll-bg, #fff);
  border-top: 1.5px solid var(--ll-bdr);
  box-shadow: 0 -4px 16px rgba(0,0,0,0.06);
  z-index: 5;
  max-height: 44vh;
  overflow-y: auto;
}
#ll-pane .kp-dr-findings-head {
  border-top: none;
  padding: 12px 0 8px;
  margin-bottom: 10px;
  position: sticky;
