...
/* — Pane — */
.ll-pane { flex: 1; min-height: 0; overflow-y: auto; padding: 22px 36px 60px; }
.ll-pane h1 { font-size: 19px; font-weight: 700; letter-spacing: -.01em; color: var(--ll-text); margin: 0 0 4px; }
.ll-pane-sub { font-size: 13.5px; color: var(--ll-text-2); margin-bottom: 18px; line-height: 1.6; max-width: 600px; }
...
.ll-about-card:hover { box-shadow: 0 3px 12px rgba(0,0,0,0.09); transform: translateY(-1px); }
.ll-about-icon-wrap {
  width: 38px; height: 38px; border-radius: 9px;
  display: flex; align-items: center; justify-content: center;
  margin-bottom: 10px;
}
.ll-about-icon-wrap svg { width: 20px; height: 20px; fill: none; stroke-width: 1.5; stroke-linecap: round; stroke-linejoin: round; }
.ll-about-card-name { font-size: 14px; font-weight: 600; color: var(--ll-text); margin-bottom: 5px; }
.ll-about-card-desc { font-size: 13px; color: var(--ll-text-2); line-height: 1.5; }
...
.ll-search-wrap {
  ...
  border-left: 1px solid var(--ll-bdr);
  height: 100%;
  flex-shrink: 0;
}
.ll-search-icon {
...
#ll-search-input {
  ...
  font: inherit; font-size: 13px; color: var(--ll-text);
  width: 180px; padding: 8px 0;
}
#ll-search-input::placeholder { color: var(--ll-text-3); }
#ll-search-input:focus { color: var(--ll-text); }
@media (max-width: 720px) {
  .ll-search-wrap { display: none; }
}
...
.ll-doorway {
  padding: 18px; border: 1px solid var(--ll-bdr); border-radius: var(--ll-radius);
  background: var(--ll-bg); cursor: pointer;
  transition: border-color .15s, transform .15s, box-shadow .15s;
}
.ll-doorway:hover { border-color: var(--ll-accent); transform: translateY(-1px); box-shadow: 0 3px 12px rgba(0,0,0,0.08); }
.ll-doorway-icon { width: 36px; height: 36px; border-radius: 8px; display: flex; align-items: center; justify-content: center; margin-bottom: 10px; }
.ll-doorway-icon svg { width: 18px; height: 18px; fill: none; stroke-width: 1.7; stroke-linecap: round; stroke-linejoin: round; }
.ll-doorway-title { font-size: 14.5px; font-weight: 700; color: var(--ll-text); margin-bottom: 3px; }
.ll-doorway-sub { font-size: 12.5px; color: var(--ll-text-2); line-height: 1.5; }

/* ── Continue widget ─────────────────────────────────────────────────── */
.ll-continue { margin-top: 14px; }
.ll-continue-head {
  font-size: 11px; font-weight: 700; letter-spacing: .12em; text-transform: uppercase;
  color: var(--ll-text-3); margin-bottom: 8px;
}
.ll-continue-list { display: flex; flex-direction: column; gap: 4px; }
.ll-continue-item {
  display: flex; align-items: center; gap: 10px;
  padding: 8px 12px; border: 1px solid var(--ll-bdr); border-radius: 6px;
...
.ll-continue-title { flex: 1; font-size: 13px; color: var(--ll-text); line-height: 1.4; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.ll-continue-when { font-size: 11.5px; color: var(--ll-text-3); flex-shrink: 0; }

/* ── Section heads (Overview) ────────────────────────────────────────── */
.ll-section-head { font-size: 11px; font-weight: 700; letter-spacing: .12em; text-transform: uppercase; color: var(--ll-text-3); margin-bottom: 4px; padding-top: 6px; }
.ll-section-sub  { font-size: 12.5px; color: var(--ll-text-2); margin-bottom: 12px; line-height: 1.5; max-width: 540px; }

/* ── Tracks ──────────────────────────────────────────────────────────── */
.ll-tracks { margin-top: 6px; }
.ll-track-grid {
  display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr));
  gap: 10px; margin-bottom: 22px;
}
.ll-track-card {
  padding: 14px 16px; border: 1px solid var(--ll-bdr); border-radius: var(--ll-radius);
  background: var(--ll-bg); cursor: pointer;
  transition: border-color .15s, transform .15s;
}
.ll-track-card:hover { border-color: var(--ll-accent); transform: translateY(-1px); }
.ll-track-card-head { display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px; }
.ll-track-pill {
  font-size: 10px; font-weight: 700; letter-spacing: .08em; text-transform: uppercase;
  color: var(--ll-text-2); padding: 2px 8px; border: 1px solid var(--ll-bdr); border-radius: 999px;
}
.ll-track-pill-team { color: #10b981; border-color: rgba(16,185,129,0.4); background: rgba(16,185,129,0.08); }
.ll-track-card-dur { font-size: 11px; color: var(--ll-text-3); }
.ll-track-card-title { font-size: 14.5px; font-weight: 700; color: var(--ll-text); line-height: 1.3; margin-bottom: 4px; }
.ll-track-card-desc { font-size: 12.5px; color: var(--ll-text-2); line-height: 1.5; }
...
/* ── Chip grid (doorway) ─────────────────────────────────────────────── */
.ll-chips { display: flex; flex-wrap: wrap; gap: 8px; margin: 14px 0 4px; }
.ll-chip {
  font: inherit; font-size: 13px; color: var(--ll-text);
...
.ll-chip:hover { border-color: var(--ll-accent); background: var(--ll-accent-soft); color: var(--ll-accent); }
...
.ll-card:hover { border-color: var(--ll-accent); transform: translateY(-1px); }
.ll-card-tag {
  align-self: flex-start;
  font-size: 10px; font-weight: 700; letter-spacing: .08em; text-transform: uppercase;
  color: #fff; padding: 2px 8px; border-radius: 4px;
}
.ll-card-title { font-size: 13px; color: var(--ll-text); line-height: 1.45; }
.ll-card-topic { font-size: 11px; color: var(--ll-text-3); }

/* ── Browse-by-mode escape hatch ─────────────────────────────────────── */
.ll-browse-modes { margin-top: 8px; border-top: 1px solid var(--ll-bdr); padding-top: 12px; }
.ll-browse-modes summary { font-size: 12px; color: var(--ll-text-2); cursor: pointer; padding: 4px 0; }
.ll-browse-modes summary:hover { color: var(--ll-accent); }
.ll-browse-modes-grid { display: flex; flex-wrap: wrap; gap: 8px; margin-top: 10px; }
.ll-browse-mode-btn {
  font: inherit; font-size: 12.5px; color: var(--ll-text-2);
  background: var(--ll-bg); border: 1px solid var(--ll-bdr); padding: 8px 12px;
  cursor: pointer; border-radius: 4px;
  transition: color .15s, background .15s;
}
.ll-browse-mode-btn:hover { color: var(--ll-text); background: #f5f5f5; }
...
<div class="ll">
  <nav class="ll-topnav" aria-label="Learning Lab modes">
    ...
    <button class="ll-tab" data-mode="jc" type="button">
      <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2L3 7v5c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V7L12 2z"/></svg>
    ...
    <div class="ll-search-wrap">
      ...
      <input id="ll-search-input" type="search" placeholder="Search 180+ atoms…" autocomplete="off" spellcheck="false" />
    </div>
