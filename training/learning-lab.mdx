...
/* — Rail header — */
.ll-rail-eyebrow { font-size: 10px; font-weight: 700; letter-spacing: .14em; text-transform: uppercase; color: var(--ll-text-3); margin-bottom: 6px; }
.ll-rail-title { font-size: 18px; font-weight: 700; color: var(--ll-text); letter-spacing: -.01em; margin-bottom: 28px; }

/* — Rail mode buttons — */
.ll-rail-nav { display: flex; flex-direction: column; gap: 2px; margin-bottom: 28px; }
.ll-rail-btn { display: flex; align-items: center; gap: 10px; padding: 9px 12px; border: none; background: none; cursor: pointer; font: inherit; color: var(--ll-text-2); text-align: left; border-radius: 6px; transition: background .15s, color .15s; }
...
.ll-rail-btn-num { font-size: 10px; font-weight: 700; color: var(--ll-text-3); min-width: 14px; }
.ll-rail-btn.active .ll-rail-btn-num { color: var(--ll-accent); }
.ll-rail-btn-label { font-size: 13.5px; }
...
/* — Pane — */
.ll-pane h1 { font-size: 22px; font-weight: 700; letter-spacing: -.01em; color: var(--ll-text); margin: 0 0 4px; }
.ll-pane-sub { font-size: 13.5px; color: var(--ll-text-3); margin-bottom: 28px; line-height: 1.6; max-width: 640px; }
...
<div class="ll">
  ...
  <div class="ll-wrap">
    <aside class="ll-rail" aria-label="Learning Lab modes">
      <div class="ll-rail-eyebrow">RI-MUHC</div>
      <div class="ll-rail-title">Learning Lab</div>
      <nav class="ll-rail-nav">
        <button class="ll-rail-btn" data-mode="kc"   type="button"><span class="ll-rail-btn-num">01</span><span class="ll-rail-btn-label">Knowledge Checks</span></button>
        <button class="ll-rail-btn" data-mode="te"   type="button"><span class="ll-rail-btn-num">02</span><span class="ll-rail-btn-label">Team Exercises</span></button>
        <button class="ll-rail-btn" data-mode="dr"   type="button"><span class="ll-rail-btn-num">03</span><span class="ll-rail-btn-label">Document Review</span></button>
        <button class="ll-rail-btn" data-mode="jc"   type="button"><span class="ll-rail-btn-num">04</span><span class="ll-rail-btn-label">Judgement Calls</span></button>
        <button class="ll-rail-btn" data-mode="insp" type="button"><span class="ll-rail-btn-num">05</span><span class="ll-rail-btn-label">Inspection Prep</span></button>
      </nav>
      <div class="ll-rail-footer">Practice tools for clinical research staff. Progress is not saved.</div>
    </aside>
