...
<div class="kp-stage" style="overflow-x:hidden">
  ...
  <div class="kp-phase" id="kp-phase-team-hub">
    ...
    <div class="kp-dr-hub-grid">
      ...
      <div class="kp-dr-hub-card active" onclick="kpStartTeamExercise('delegation')">
        ...
        <div class="kp-dr-hub-title">Delegation Boundaries on the Study Team</div>
      ...
      <div class="kp-dr-hub-card active" onclick="kpStartTeamExercise('consent')">
        ...
        <div class="kp-dr-hub-title">Verifying a Consent Was Properly Obtained</div>
      ...
      <div class="kp-dr-hub-card active" onclick="kpStartTeamExercise('sae')">
        ...
        <div class="kp-dr-hub-title">Working Through an SAE Cascade</div>
      ...
      <div class="kp-dr-hub-card active" onclick="kpStartTeamExercise('deviations')">
        ...
        <div class="kp-dr-hub-title">Classifying Protocol Deviations</div>
      ...
      <div class="kp-dr-hub-card active" onclick="kpStartTeamExercise('monitoring')">
        ...
        <div class="kp-dr-hub-title">Preparing for an Inspection</div>
      ...
      <div class="kp-dr-hub-card active" onclick="kpStartTeamExercise('data')">
        ...
        <div class="kp-dr-hub-title">Identifying the Source Record</div>
      ...
      <div class="kp-dr-hub-card active" onclick="kpStartTeamExercise('recruitment')">
        ...
        <div class="kp-dr-hub-title">Recruitment and Eligibility Decisions</div>
      ...
      <div class="kp-dr-hub-card active" onclick="kpStartTeamExercise('gcp')">
        ...
        <div class="kp-dr-hub-title">Working with GCP Principles in Practice</div>
  ...
  <div class="kp-phase" id="kp-phase-te-delegation">
    ...
    <h2 style="font-size:clamp(20px,2.5vw,28px);font-weight:800;color:var(--navy);letter-spacing:-.02em;line-height:1.1;margin:0 0 32px;max-width:720px">Delegation Boundaries on the Study Team</h2>
...
<li class="te-question">
  ...
  <div class="kp-phase" id="kp-phase-te-consent">
    ...
    <h2 style="font-size:clamp(20px,2.5vw,28px);font-weight:800;color:var(--navy);letter-spacing:-.02em;line-height:1.1;margin:0 0 32px;max-width:720px">Verifying a Consent Was Properly Obtained</h2>
  ...
  <div class="kp-phase" id="kp-phase-te-sae">
    ...
    <h2 style="font-size:clamp(20px,2.5vw,28px);font-weight:800;color:var(--navy);letter-spacing:-.02em;line-height:1.1;margin:0 0 32px;max-width:720px">Working Through an SAE Cascade</h2>
  ...
  <div class="kp-phase" id="kp-phase-te-deviations">
    ...
    <h2 style="font-size:clamp(20px,2.5vw,28px);font-weight:800;color:var(--navy);letter-spacing:-.02em;line-height:1.1;margin:0 0 32px;max-width:720px">Classifying Protocol Deviations</h2>
  ...
  <div class="kp-phase" id="kp-phase-te-monitoring">
    ...
    <h2 style="font-size:clamp(20px,2.5vw,28px);font-weight:800;color:var(--navy);letter-spacing:-.02em;line-height:1.1;margin:0 0 32px;max-width:720px">Preparing for an Inspection</h2>
...
export const LL_HTML_2 = `  <div class="te-block">
  ...
  <div class="kp-phase" id="kp-phase-te-data">
    ...
    <h2 style="font-size:clamp(20px,2.5vw,28px);font-weight:800;color:var(--navy);letter-spacing:-.02em;line-height:1.1;margin:0 0 32px;max-width:720px">Identifying the Source Record</h2>
  ...
  <div class="kp-phase" id="kp-phase-te-recruitment">
    ...
    <h2 style="font-size:clamp(20px,2.5vw,28px);font-weight:800;color:var(--navy);letter-spacing:-.02em;line-height:1.1;margin:0 0 32px;max-width:720px">Recruitment and Eligibility Decisions</h2>
  ...
  <div class="kp-phase" id="kp-phase-te-gcp">
    ...
    <h2 style="font-size:clamp(20px,2.5vw,28px);font-weight:800;color:var(--navy);letter-spacing:-.02em;line-height:1.1;margin:0 0 32px;max-width:720px">Working with GCP Principles in Practice</h2>
    ...
    <ul class="te-questions">
      <li class="te-question">
        ...
        <div class="te-kp-body">
          ...
          <span class="te-kp-ref">ICH E6(R3) &sect;2.3 &middot; GCP Principle 5 (Qualified Individuals) &middot; C.05.010(g)</span>
        </div>
      </li>
    </ul>
  </div>
    ...
    <ul class="te-questions">
      <li class="te-question">
        ...
        <div class="te-kp-body">
          ...
          <span class="te-kp-ref">ICH E6(R3) GCP Principle 6 (Quality by Design) &middot; C.05.012 &middot; Health Canada inspection authority</span>
        </div>
      </li>
    </ul>
  </div>
    ...
    <ul class="te-questions">
      <li class="te-question">
        ...
        <div class="te-kp-body">
          ...
          <span class="te-kp-ref">ICH E6(R3) GCP Principle 6 (Quality by Design — Critical-to-Quality factors) &middot; Principle 1 (Ethical Conduct)</span>
        </div>
      </li>
    </ul>
  </div>
      ...
      },
      {
        ...
        choices: [
          ...
          { text: 'I can ask him, but I can’t promise he’ll sign without reading them. Would it help if I got him to sign two of the three?', quality: 'partial', label: 'Right instinct, but negotiating weakens your position',
            feedback: '<p>You correctly flagged that the PI should read before signing. But <strong>offering to get him to sign two of the three is still asking him to sign documents without adequate review time.</strong> The problem is not the number of documents — it is whether the PI has actually reviewed what he is signing.</p><p>Negotiating a partial compromise (“two of three”) signals that the principle is flexible. It is not. The CRA’s timeline is a logistical constraint, not a reason to weaken PI oversight. If the sponsor’s system cannot accommodate a PI who reviews documents before signing them, that is a process issue for the sponsor to resolve.</p><span class="jc-fb-ref">ICH E6(R3) §2.3.1 · GCP Principle 10 (Defined Roles and Responsibilities) · [SOP-CR-002](/sops/cr-002), [SOP-CR-013](/sops/cr-013)</span>' },
          { text: 'I can’t ask him to sign documents he hasn’t reviewed — his signature means he’s read and agreed, and that has to be true when he signs it. I’ll put them on his desk with a note. If your system needs them today, that’s a timeline issue on the sponsor side, not a reason to short-circuit PI review.', quality: 'good', label: 'Correct',
            feedback: '<p>This is the right response. You protected the integrity of the PI’s signature, correctly identified that the sponsor’s timeline does not override the requirement for genuine review, and offered a practical next step (documents on his desk) without compromising the principle.</p><p>Framing it as “a timeline issue on the sponsor side” is important — it names the real source of the pressure without being adversarial. The CRA’s flight schedule is not your problem to solve by cutting corners.</p><span class="jc-fb-ref">ICH E6(R3) §2.3.1 (PI oversight) · GCP Principle 10 (Defined Roles and Responsibilities) · [SOP-CR-002](/sops/cr-002), [SOP-CR-013](/sops/cr-013)</span>' }
        ]
      }
    ],
    endings: {
      ...
      {label:'Pressure point 1 — The rescreen',
       ...
       choices:[
         ...
         {text:'I’d need to review her chart first — there might be a clinical reason to retest, but I can’t commit to it on this call.',quality:'good',label:'Correct',
          feedback:'<p>You’re leaving the door open for a clinically justified retest while making clear that the decision is medical, not logistical. If you review the chart and find a clinical reason, a retest is defensible. If there’s no basis, the answer is no.</p><span class="jc-fb-ref">ICH E6(R3) Principle 3 (Independent Review) · [SOP-CR-004](/sops/cr-004) · [SOP-CR-009](/sops/cr-009)</span>'}
       ]},
...
.ll {
  ...
  color: var(--ll-text);
  background:
    radial-gradient(ellipse 80% 60% at 92% -5%, rgba(144,57,249,0.04) 0%, transparent 55%),
    radial-gradient(ellipse 70% 50% at -5% 105%, rgba(43,156,226,0.04) 0%, transparent 55%),
    #fafafa;
  display: flex;
...
/* — Top navigation: home + search + status — */
.ll-topnav {
  display: flex;
  align-items: center;
  gap: 12px;
...
.ll-home {
  ...
  color: var(--ll-text); transition: background .15s, color .15s;
}
.ll-home svg { width: 18px; height: 18px; stroke: var(--ll-accent); fill: none; stroke-width: 1.7; stroke-linecap: round; stroke-linejoin: round; }
.ll-home:hover { background: var(--ll-accent-soft); }

/* — Pane — */
.ll-pane { flex: 1; min-height: 0; overflow-y: auto; padding: 28px 40px 80px; }
.ll-pane h1 { font-size: 24px; font-weight: 800; letter-spacing: -.02em; color: var(--ll-text); margin: 0 0 6px; }
.ll-pane-sub { font-size: 14px; color: var(--ll-text-2); margin-bottom: 22px; line-height: 1.6; max-width: 640px; }
...
@media print {
  ...
  .ll { height: auto !important; display: block !important; }
  .ll { background: #fff !important; }
  .ll-pane { height: auto !important; overflow: visible !important; padding: 0; }

  /* Sessions print: hide nav chrome, expand all collapsibles, keep page-breaks tidy */
  .ll-no-print, .ll-back-btn, .ll-session-actions, .ll-session-item-open { display: none !important; }
  .ll-session-print-head {
    display: block !important;
    font-size: 10px; font-weight: 600; color: #555;
    border-bottom: 1px solid #ccc; padding-bottom: 6px; margin-bottom: 14px;
    text-transform: uppercase; letter-spacing: .1em;
  }
  .ll-session h1 { font-size: 22px; margin-bottom: 4px; }
  .ll-session-meta { font-size: 11px; }
  .ll-session-overview { font-size: 12px; line-height: 1.55; }
  .ll-session-item { break-inside: avoid; page-break-inside: avoid; border-color: #999; }
  .ll-session-item-num { border-color: #333; color: #333; background: #fff; }
  .ll-session-item-kind { color: #555; }
  .ll-session-item-kind svg { stroke: #555; }
  .ll-session-item-title { font-size: 13px; }
  .ll-session-note-label { color: #555; }
  .ll-session-note-text { font-size: 11.5px; line-height: 1.5; }
  .ll-session-reflection { break-inside: avoid; page-break-inside: avoid; border-top-color: #999; }
  .ll-session-reflection-list li { font-size: 12px; }
}

/* ── Knowledge Checks ─────────────────────────────────────────────── */
.ll-kc-controls { display: flex; align-items: center; justify-content: space-between; margin-bottom: 18px; flex-wrap: wrap; gap: 10px; }
...
.ll-kc-topics { display: grid; grid-template-columns: repeat(auto-fill, minmax(240px, 1fr)); gap: 8px; margin-top: 4px; }
.ll-kc-topic { padding: 12px 16px; border: 1px solid var(--ll-bdr); border-radius: var(--ll-radius); cursor: pointer; transition: border-color .15s, background .15s; }
...
/* Sequence view */
.ll-kc-seq-nav { display: flex; align-items: center; gap: 14px; margin-bottom: 4px; }
...
.ll-kc-seq-label { font-size: 16px; font-weight: 700; color: var(--ll-text); letter-spacing: -.01em; margin-bottom: 14px; }
...
.ll-te-item { display: flex; flex-direction: column; gap: 2px; padding: 12px 0; border-bottom: 1px solid var(--ll-bdr); cursor: pointer; }
...
.ll-jc-scenario { padding: 12px 16px; border: 1px solid var(--ll-bdr); border-radius: var(--ll-radius); cursor: pointer; transition: border-color .15s, background .15s; }
.ll-jc-scenario:hover { border-color: var(--ll-accent); background: var(--ll-accent-soft); }
.ll-jc-scenario-coming { padding: 12px 16px; border: 1px solid var(--ll-bdr); border-radius: var(--ll-radius); opacity: .45; }
...
/* About (legacy cards — kept for any old refs but unused by new render) */
.ll-about-grid { display: none; }
...
.ll-search-wrap:focus-within { background: var(--ll-bg); border-color: var(--ll-accent); }
.ll-search-icon {
  width: 15px; height: 15px;
  stroke: var(--ll-text-3); fill: none; stroke-width: 2; stroke-linecap: round; stroke-linejoin: round;
  flex-shrink: 0;
}
#ll-search-input {
  border: none; outline: none; background: transparent;
  font: inherit; font-size: 13.5px; color: var(--ll-text);
  width: 100%; padding: 2px 0;
}
#ll-search-input::placeholder { color: var(--ll-text-3); }
@media (max-width: 720px) {
  .ll-topnav { padding: 8px 12px; gap: 8px; }
  .ll-home span { display: none; }
}

/* ── Doorways (Overview) — three big friendly entry points ───────────── */
.ll-doorways {
...
.ll-doorway {
  ...
  border: 1px solid var(--ll-bdr); border-radius: 14px;
...
.ll-doorway::before {
  ...
  background: linear-gradient(135deg, var(--dw-tint, rgba(43,156,226,0.06)) 0%, transparent 70%);
  pointer-events: none;
  opacity: .7;
  transition: opacity .2s ease;
}
.ll-doorway:hover {
  border-color: var(--dw-accent, var(--ll-accent));
  transform: translateY(-2px);
  box-shadow: 0 8px 24px rgba(17,17,17,0.06);
}
.ll-doorway:hover::before { opacity: 1; }
.ll-doorway-icon {
  position: relative;
  width: 48px; height: 48px; border-radius: 12px;
  display: flex; align-items: center; justify-content: center;
  margin-bottom: 14px;
  background: var(--dw-tint, rgba(43,156,226,0.10));
}
.ll-doorway-icon svg {
  width: 24px; height: 24px;
  fill: none; stroke: var(--dw-accent, var(--ll-accent));
  stroke-width: 2; stroke-linecap: round; stroke-linejoin: round;
}
.ll-doorway-title { position: relative; font-size: 17px; font-weight: 700; color: var(--ll-text); margin-bottom: 4px; letter-spacing: -.01em; }
.ll-doorway-sub { position: relative; font-size: 13px; color: var(--ll-text-2); line-height: 1.55; }
.ll-doorway-arrow {
...
.ll-doorway:hover .ll-doorway-arrow { stroke: var(--dw-accent, var(--ll-accent)); transform: translateX(2px); }

/* ── Topnav link (Library + others) ──────────────────────────────────── */
.ll-topnav-link {
  background: none; border: none; padding: 6px 12px; border-radius: 8px;
  cursor: pointer; font: inherit; font-size: 13.5px; color: var(--ll-text-2);
  transition: background .15s, color .15s;
}
.ll-topnav-link:hover { background: var(--ll-accent-soft); color: var(--ll-accent); }

/* ── Library tile (Overview, peer to doorways) ───────────────────────── */
.ll-library-tile {
  display: flex; align-items: center; gap: 18px;
  width: 100%; padding: 18px 22px;
  border: 1px solid var(--ll-bdr); border-radius: 12px;
  background: var(--ll-bg); cursor: pointer; font: inherit; text-align: left;
  transition: border-color .2s ease, transform .2s ease, box-shadow .2s ease;
}
.ll-library-tile:hover { border-color: var(--ll-accent); transform: translateY(-1px); box-shadow: 0 4px 14px rgba(17,17,17,0.04); }
.ll-library-tile-body { flex: 1; min-width: 0; }
.ll-library-tile-title { font-size: 15.5px; font-weight: 700; color: var(--ll-text); margin-bottom: 4px; letter-spacing: -.005em; }
.ll-library-tile-sub { font-size: 13px; color: var(--ll-text-2); line-height: 1.5; }
.ll-library-tile-arrow {
  width: 20px; height: 20px; flex-shrink: 0;
  stroke: var(--ll-text-3); fill: none; stroke-width: 2; stroke-linecap: round; stroke-linejoin: round;
  transition: stroke .2s ease, transform .2s ease;
}
.ll-library-tile:hover .ll-library-tile-arrow { stroke: var(--ll-accent); transform: translateX(2px); }

/* ── Doorway: selected chip + inline results section ─────────────────── */
.ll-chip.selected { border-color: var(--ll-accent); background: var(--ll-accent-soft); color: var(--ll-accent); font-weight: 600; }
.ll-doorway-results { margin-top: 22px; padding-top: 18px; border-top: 1px solid var(--ll-bdr); }

/* ── Two-tile alternative grid (Library + Sessions) on Overview ──────── */
.ll-alt-tiles { display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 12px; }

/* ── Sessions list page ──────────────────────────────────────────────── */
.ll-sessions-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 12px; margin-top: 6px; }
.ll-session-card {
  display: flex; flex-direction: column; gap: 8px;
  padding: 18px 20px; border: 1px solid var(--ll-bdr); border-radius: 12px;
  background: var(--ll-bg); cursor: pointer; font: inherit; text-align: left;
  transition: border-color .2s ease, transform .2s ease, box-shadow .2s ease;
}
.ll-session-card:hover { border-color: var(--ll-accent); transform: translateY(-1px); box-shadow: 0 4px 14px rgba(17,17,17,0.04); }
.ll-session-card-head { display: flex; align-items: center; gap: 10px; }
.ll-session-card-dur { font-size: 11px; font-weight: 700; letter-spacing: .1em; text-transform: uppercase; color: var(--ll-accent); padding: 3px 9px; border: 1px solid var(--ll-accent); border-radius: 999px; background: var(--ll-accent-soft); }
.ll-session-card-title { font-size: 15.5px; font-weight: 700; color: var(--ll-text); line-height: 1.3; letter-spacing: -.005em; }
.ll-session-card-aud { font-size: 12px; color: var(--ll-text-3); line-height: 1.45; margin-top: -4px; }
.ll-session-card-overview { font-size: 13px; color: var(--ll-text-2); line-height: 1.55; }
.ll-session-card-meta { font-size: 11.5px; color: var(--ll-text-3); margin-top: 4px; }

/* ── Session detail page ─────────────────────────────────────────────── */
.ll-session { max-width: 760px; }
.ll-session-print-head { display: none; }
.ll-session-meta { font-size: 13px; color: var(--ll-text-3); margin: -10px 0 16px; }
.ll-session-overview { font-size: 14px; color: var(--ll-text-2); line-height: 1.65; margin-bottom: 18px; max-width: 640px; }
.ll-session-actions { margin-bottom: 26px; }
.ll-session-action {
  font: inherit; font-size: 13px; color: var(--ll-text-2);
  background: var(--ll-bg); border: 1px solid var(--ll-bdr); padding: 8px 16px; border-radius: 8px;
  cursor: pointer; transition: border-color .15s, color .15s;
}
.ll-session-action:hover { border-color: var(--ll-accent); color: var(--ll-accent); }

.ll-session-items { list-style: none; padding: 0; margin: 0; counter-reset: none; display: flex; flex-direction: column; gap: 14px; }
.ll-session-item {
  border: 1px solid var(--ll-bdr); border-radius: 12px; padding: 18px 20px;
  background: var(--ll-bg);
}
.ll-session-item-head { display: flex; align-items: flex-start; gap: 14px; margin-bottom: 12px; }
.ll-session-item-num {
  flex-shrink: 0; width: 28px; height: 28px;
  border: 1.5px solid var(--ll-accent); border-radius: 50%;
  display: flex; align-items: center; justify-content: center;
  font-size: 13px; font-weight: 700; color: var(--ll-accent);
  background: var(--ll-accent-soft);
}
.ll-session-item-head-meta { flex: 1; min-width: 0; }
.ll-session-item-kind {
  display: inline-flex; align-items: center; gap: 6px;
  font-size: 10.5px; font-weight: 700; letter-spacing: .1em; text-transform: uppercase;
  color: var(--ll-text-3); margin-bottom: 4px;
}
.ll-session-item-kind svg { width: 13px; height: 13px; stroke: var(--ll-text-3); fill: none; stroke-width: 2; stroke-linecap: round; stroke-linejoin: round; }
.ll-session-item-title { font-size: 14.5px; font-weight: 600; color: var(--ll-text); line-height: 1.4; }
.ll-session-item-open {
  flex-shrink: 0;
  font: inherit; font-size: 12.5px; color: var(--ll-accent); font-weight: 600;
  background: none; border: 1px solid var(--ll-accent); padding: 6px 14px; border-radius: 6px;
  cursor: pointer; transition: background .15s;
}
.ll-session-item-open:hover { background: var(--ll-accent-soft); }
.ll-session-item-notes { display: flex; flex-direction: column; gap: 10px; padding-left: 42px; }
.ll-session-note { display: flex; gap: 10px; }
.ll-session-note-label {
  flex-shrink: 0; width: 76px;
  font-size: 10.5px; font-weight: 700; letter-spacing: .1em; text-transform: uppercase;
  color: var(--ll-text-3); padding-top: 1px;
}
.ll-session-note-text { flex: 1; font-size: 13px; color: var(--ll-text-2); line-height: 1.55; }

.ll-session-reflection { margin-top: 32px; padding-top: 22px; border-top: 1px solid var(--ll-bdr); }
.ll-session-reflection-list { padding-left: 22px; margin: 4px 0 0; }
.ll-session-reflection-list li { font-size: 13.5px; color: var(--ll-text); line-height: 1.6; margin-bottom: 8px; }

/* ── Library: topic-card grid (high-level topic index) ───────────────── */
.ll-topic-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 12px; margin-top: 4px; }
.ll-topic-card {
  display: block; width: 100%; text-align: left;
  padding: 18px 20px; border: 1px solid var(--ll-bdr); border-radius: 12px;
  background: var(--ll-bg); cursor: pointer; font: inherit;
  transition: border-color .2s ease, transform .2s ease, box-shadow .2s ease;
}
.ll-topic-card:hover { border-color: var(--ll-accent); transform: translateY(-1px); box-shadow: 0 4px 14px rgba(17,17,17,0.04); }
.ll-topic-card-head { display: flex; align-items: baseline; justify-content: space-between; gap: 12px; margin-bottom: 6px; }
.ll-topic-card-title { font-size: 15.5px; font-weight: 700; color: var(--ll-text); letter-spacing: -.005em; }
.ll-topic-card-count { font-size: 13px; font-weight: 700; color: var(--ll-text-3); flex-shrink: 0; transition: color .15s; }
.ll-topic-card:hover .ll-topic-card-count { color: var(--ll-accent); }
.ll-topic-card-breakdown { font-size: 12px; color: var(--ll-text-3); line-height: 1.45; }

/* ── Breadcrumb / back row above page H1 ─────────────────────────────── */
.ll-breadcrumb { margin-bottom: 14px; }

/* ── Browse-by-topic chip strip (kept for legacy; no longer on Overview) ─ */
.ll-topics-strip { margin: 4px 0 28px; }
.ll-topics-strip-chips { display: flex; flex-wrap: wrap; gap: 6px; }
.ll-topic-chip {
  font: inherit; font-size: 12.5px; color: var(--ll-text-2);
  background: var(--ll-bg); border: 1px solid var(--ll-bdr);
  padding: 6px 12px; border-radius: 999px; cursor: pointer;
  transition: border-color .15s, background .15s, color .15s;
}
.ll-topic-chip:hover { border-color: var(--ll-accent); background: var(--ll-accent-soft); color: var(--ll-accent); }

/* ── Topic page (sections by interaction kind) ───────────────────────── */
.ll-topic-section { margin: 22px 0 8px; }
.ll-topic-section-head {
  display: flex; align-items: center; gap: 8px;
  font-size: 13px; font-weight: 700; color: var(--ll-text);
  letter-spacing: -.005em; margin-bottom: 10px;
}
.ll-topic-section-head svg {
  width: 15px; height: 15px;
  stroke: var(--ll-text-2); fill: none;
  stroke-width: 1.7; stroke-linecap: round; stroke-linejoin: round;
}
.ll-topic-section-count {
  font-size: 11px; font-weight: 600; color: var(--ll-text-3);
  margin-left: 4px;
}

/* ── Next-best-item recommender (end-of-item) ────────────────────────── */
.ll-next-best { margin: 32px 0 8px; padding-top: 22px; border-top: 1px solid var(--ll-bdr); }
.ll-next-best-head {
  font-size: 11px; font-weight: 700; letter-spacing: .12em; text-transform: uppercase;
  color: var(--ll-text-3); margin-bottom: 12px;
}
.ll-next-best-list { display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 10px; }
.ll-next-best-item {
  display: flex; align-items: flex-start; gap: 12px;
  padding: 12px 14px; border: 1px solid var(--ll-bdr); border-radius: 10px;
  background: var(--ll-bg); cursor: pointer; font: inherit; text-align: left;
  transition: border-color .15s, background .15s;
}
.ll-next-best-item:hover { border-color: var(--ll-accent); background: var(--ll-accent-soft); }
.ll-next-best-icon { flex-shrink: 0; width: 18px; height: 18px; stroke: var(--ll-text-2); fill: none; stroke-width: 1.7; stroke-linecap: round; stroke-linejoin: round; margin-top: 2px; }
.ll-next-best-meta { display: flex; flex-direction: column; flex: 1; min-width: 0; }
.ll-next-best-kind { font-size: 10.5px; font-weight: 700; letter-spacing: .1em; text-transform: uppercase; color: var(--ll-text-3); margin-bottom: 4px; }
.ll-next-best-title { font-size: 13px; color: var(--ll-text); line-height: 1.45; }

/* ── Section heads (Overview) ────────────────────────────────────────── */
.ll-section-head { display: flex; align-items: baseline; gap: 10px; font-size: 17px; font-weight: 700; color: var(--ll-text); letter-spacing: -.01em; margin-bottom: 4px; }
.ll-section-head-count { font-size: 12px; font-weight: 600; color: var(--ll-text-3); }
.ll-section-sub  { font-size: 13px; color: var(--ll-text-2); margin-bottom: 14px; line-height: 1.55; max-width: 560px; }

/* ── Tracks ──────────────────────────────────────────────────────────── */
.ll-tracks { margin-top: 14px; }
.ll-track-grid {
...
.ll-track-card:hover { border-color: var(--ll-accent); box-shadow: 0 4px 14px rgba(17,17,17,0.04); }
.ll-track-card-title { font-size: 15.5px; font-weight: 700; color: var(--ll-text); line-height: 1.3; margin-bottom: 6px; letter-spacing: -.01em; }
.ll-track-card-desc { font-size: 13px; color: var(--ll-text-2); line-height: 1.55; }
.ll-track-card-meta { font-size: 11.5px; color: var(--ll-text-3); margin-top: 10px; font-weight: 600; }

/* Track detail view */
.ll-track-meta { font-size: 12px; color: var(--ll-text-3); margin: -8px 0 18px; }
.ll-track-steps { list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 8px; }
.ll-track-step {
  display: flex; align-items: flex-start; gap: 12px;
  padding: 12px 14px; border: 1px solid var(--ll-bdr); border-radius: var(--ll-radius);
  background: var(--ll-bg); cursor: pointer;
  transition: border-color .15s, background .15s;
}
.ll-track-step:hover { border-color: var(--ll-accent); }
/* Track-step done/current variants removed — no progress persistence */
.ll-track-step-num {
  flex-shrink: 0; width: 26px; height: 26px;
  border: 1.5px solid var(--ll-bdr); border-radius: 50%;
  display: flex; align-items: center; justify-content: center;
  font-size: 12px; font-weight: 700; color: var(--ll-text-2);
  background: var(--ll-bg);
}
.ll-track-step-body { flex: 1; min-width: 0; }
.ll-track-step-kind { font-size: 10.5px; font-weight: 700; letter-spacing: .08em; text-transform: uppercase; color: var(--ll-text-3); margin-bottom: 2px; }
.ll-track-step-label { font-size: 13.5px; font-weight: 600; color: var(--ll-text); line-height: 1.35; }

/* ── Chip grid (doorway) ─────────────────────────────────────────────── */
.ll-chips { display: flex; flex-wrap: wrap; gap: 10px; margin: 18px 0 4px; }
.ll-chip {
  font: inherit; font-size: 13.5px; font-weight: 500; color: var(--ll-text);
  background: var(--ll-bg); border: 1px solid var(--ll-bdr);
  padding: 10px 16px; border-radius: 999px; cursor: pointer;
  transition: border-color .15s, background .15s, color .15s, transform .15s;
}
.ll-chip:hover { border-color: var(--ll-accent); background: var(--ll-accent-soft); color: var(--ll-accent); transform: translateY(-1px); }
.ll-chip-count {
  display: inline-block; margin-left: 8px;
  font-size: 11px; font-weight: 600; color: var(--ll-text-3);
  background: rgba(0,0,0,0.04); border-radius: 999px; padding: 1px 7px;
  min-width: 18px; text-align: center;
}
.ll-chip.selected .ll-chip-count { background: rgba(43,156,226,0.15); color: var(--ll-accent); }
.ll-doorway-showall {
  font: inherit; font-size: 13px; color: var(--ll-accent); font-weight: 600;
  background: none; border: 1px solid var(--ll-accent); padding: 8px 16px; border-radius: 8px;
  cursor: pointer; transition: background .15s;
}
.ll-doorway-showall:hover { background: var(--ll-accent-soft); }

/* Search-result filter tags (small chips above the result count) */
.ll-search-tags { display: flex; flex-wrap: wrap; gap: 6px; margin: -6px 0 12px; }
.ll-search-tag {
  font-size: 11.5px; font-weight: 600; color: var(--ll-text-2);
  background: var(--ll-bg); border: 1px solid var(--ll-bdr);
...
.ll-card {
  padding: 14px 16px; border: 1px solid var(--ll-bdr); border-radius: 10px;
  background: var(--ll-bg); cursor: pointer;
  transition: border-color .15s, background .15s;
  display: flex; flex-direction: column; gap: 8px;
}
.ll-card:hover { border-color: var(--ll-accent); background: var(--ll-accent-soft); }
.ll-card-kind {
  display: inline-flex; align-items: center; gap: 6px;
  font-size: 10.5px; font-weight: 700; letter-spacing: .1em; text-transform: uppercase;
  color: var(--ll-text-3);
}
.ll-card-kind svg { width: 13px; height: 13px; stroke: var(--ll-text-3); fill: none; stroke-width: 2; stroke-linecap: round; stroke-linejoin: round; }
.ll-card-kind-dur { color: var(--ll-text-3); font-weight: 600; letter-spacing: .05em; }
.ll-card-title { font-size: 13.5px; font-weight: 600; color: var(--ll-text); line-height: 1.45; }
.ll-card-topic { font-size: 11.5px; color: var(--ll-text-3); }
...
/* DR: findings panel — natural position below table, visually separated */
#ll-pane .kp-dr-findings.visible {
  margin-top: 32px;
  padding-top: 24px;
  border-top: 2px solid var(--ll-bdr);
}
/* Compact table to reduce horizontal scroll */
#ll-pane .kp-dr-table { font-size: 11.5px; }
#ll-pane .kp-dr-table th { padding: 7px 10px; font-size: 9px; }
#ll-pane .kp-dr-row td { padding: 8px 10px; }
...
/* ══ TEAM EXERCISES — flow, rhythm, visual separation ═════════════════ */
/* Section heads: bigger, clearer anchors */
#ll-pane .te-section-head {
  font-size: 12px;
  letter-spacing: .08em;
  color: var(--ll-text-2);
  border-bottom: 1.5px solid var(--ll-bdr);
  padding-bottom: 8px;
  margin-top: 44px;
  margin-bottom: 18px;
  max-width: none;
}
/* Blocks: lighter border, more vertical rhythm */
#ll-pane .te-block { margin-top: 0; margin-bottom: 4px; border-color: var(--ll-bdr); border-radius: 6px; overflow: hidden; }
#ll-pane .te-situation { padding: 18px 22px; }
#ll-pane .te-situation-eyebrow { margin-bottom: 10px; }
/* Question items: clean separation, generous text area */
#ll-pane .te-question { border-top-color: var(--ll-bdr); }
#ll-pane .te-q-text { padding: 18px 22px; font-size: 14px; line-height: 1.65; }
#ll-pane .te-kp-toggle { padding: 11px 22px; }
#ll-pane .te-kp-body { padding: 18px 22px 22px; background: #f8f9fa; }
/* Roster and intro */
#ll-pane .te-roster-item { padding: 12px 16px; border-radius: 6px; }
#ll-pane .te-case-intro p { font-size: 14px; line-height: 1.75; }
#ll-pane .te-reflection { padding: 18px 22px; border-radius: 6px; }
/* Print bar: less prominent */
#ll-pane .te-print-bar { border-radius: 4px; margin-bottom: 24px; opacity: 0.8; }
...
#ll-pane .te-situation { border-left: 3px solid var(--ll-accent); border-bottom: 1px solid var(--ll-bdr); }
...
<div class="ll">
  <nav class="ll-topnav" aria-label="Learning Lab">
    <button class="ll-home" type="button" aria-label="Learning Lab home">
    ...
    <button class="ll-topnav-link" type="button" data-route="library">Library</button>
    <button class="ll-topnav-link" type="button" data-route="sessions">Sessions</button>
    <div class="ll-search-wrap">
      <svg class="ll-search-icon" viewBox="0 0 24 24" aria-hidden="true"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
      <input id="ll-search-input" type="search" placeholder="Search practice items…" autocomplete="off" spellcheck="false" />
    </div>
  </nav>
