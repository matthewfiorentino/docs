...
This SOP describes the required communication for ongoing study submissions between the Sponsor-Investigator or Qualified Investigator (QI)/Principal Investigator (PI) and the MUHC Research Ethics Board (REB) and feasibility reviewers throughout the duration of human research studies. It also describes the upkeep of the web-accessible registration of the study. For Initial and Annual Continuing Review and initial study registration, refer to SOP-CR-007.

This procedure concerns the research community (employees, investigators, sponsor-investigators, physicians, management, consultants, students, volunteers, or other persons) involved in the ongoing study submission process. This ongoing review ensures that participant rights, safety, and well-being are maintained between annual Continuing Reviews. This procedure also concerns research team members who are updating their publicly accessible study registration.
...
- Provide regulatory agencies (e.g., Health Canada) with CTA-amendments or notifications where applicable → SOP-CR-018, SOP-CR-023, SOP-CR-024. Obtain written approval from Health Canada, file in the TMF, and forward a copy of the NOL/NOA/ITA to investigators to file in their ISFs.
- Provide regulatory agencies with all reportable SAEs and reportable Medical Device Incidents within required timelines → SOP-CR-012.
...
- Provide investigators with all external SUSARs or MDI reports in a timely fashion and request that the Investigator document their review and distribution to team members and to the REB (where applicable) within the required timelines → SOP-CR-012.
- Ensure that all reportable protocol/GCP deviations are reported to the REB by the site in a timely fashion per REB SOPs.

**5.1.3** Collect documentation of Investigator oversight and file in the Trial Master File (TMF):
- Documentation of Investigator's amendment review (e.g., protocol or IB amendment signature page)
...
**5.1.4** Provide investigators with an SAE reporting process and tools (e.g., SAE report templates). Collect all SAEs from sites → SOP-CR-012 for a report template.

**5.1.5** Expedite SUSAR/MDI reports and document Investigator oversight throughout the study:
- Expedite reporting to all concerned investigators and regulatory authorities of all adverse events/incidents that are serious, unexpected, and possibly/probably/definitely related to the IP, in compliance with ICH Guidelines for Clinical Safety Data Management or ISO 14155 GCP.
...
- → SOP-CR-016 for Study Close-Out.
...
**5.3.1** Over the course of the study, the Investigator must inform the REB about the following events via the appropriate Nagano forms, **prior to their implementation**:
...
- SAE or MDI that is unexpected and at least possibly related to IP or study conduct and poses greater risk of harm to participants → SOP-CR-012, SOP-CR-024
...
- Request to convert to a Quebec multi-centrique study or add a new RSSS site
...
- Any serious and unexpected adverse reaction or MDI involving an MUHC/RI-MUHC participant that is at least possibly related to participation in the study and poses greater risk of harm. Always remove all participant identifiers — use participant enrollment number only. Report to the Sponsor within 24 hours and to the REB within 7 days (life-threatening) or 15 days of becoming aware → SOP-CR-012, SOP-CR-024.
...
- Any new information affecting participant safety or their willingness to continue — also reflected in an amended ICF.
...
All protocol deviations observed by the site (intentional or not) or detected by a monitor, auditor, or inspector must be documented on the Protocol/GCP/SOP Deviation Log (Appendix 1), assessed for trends, and addressed with corrective and preventive action as applicable.
...
All minor deviations may be collected and submitted to the REB at the time of annual Continuing Review → SOP-CR-007.
...
- Data indicating a particular AE is more severe or more frequent than expected
...
- Inspection or audit report observations relevant to the safety and well-being of participants (including findings from HC inspections, FDA audits, Sponsor audits, or internal RI-MUHC QA audits)
...
**5.4.1** Multi-centrique research involves more than one QI/PI from the Quebec public health care network conducting the study under the same Sponsor/Sponsor-Investigator. For REB reporting flowchart, refer to the MUHC CAE website: https://muhc.ca/cae/multicentre-study.
...
**5.4.4** If an external multi-centrique QI/PI does not have Nagano access, they must complete the relevant PDF form (available at https://muhc.ca/cae/page/multicentre-study), and the MUHC research team must submit these through Nagano. This applies to:
...
**5.6.1** Once study close-out has occurred per SOP-CR-016, submit a Closure of Research Project form to the REB when: there are no further participants on study, all data collection is complete, and the Sponsor's Close-Out report has been completed.

**5.6.2** The QI/PI must report the change in study status to the REB in a timely fashion (ideally within 30 days of the Close-Out visit).
...
**5.8.3** For additional information on submitting complaints or breaches of privacy to the REB → MUHC REB SOP 405 and SOP-CR-019.

### 5.9 Informing the REB of inspections and audits

**5.9.1** In addition to internal RI-MUHC QA audits, external bodies (Health Canada, FDA, EMA, Sponsor, or funding agencies such as CIHR) may conduct inspections or audits. The Sponsor-Investigator or Investigator is responsible for notifying the REB of any planned audits or inspections of research projects overseen by the REB → MUHC REB SOP 701. See also SOP-CR-017.
...
**5.10.2** For insurance purposes, in the clinicaltrials.gov record, **MUHC-RIMUHC** must be entered for "Sponsor" → SOP-CR-007.
...
- Appendix 1 — Protocol/GCP/SOP Deviation Log
- Appendix 2 — Corrective and Preventive Action (CAPA) Form
...
<Update label="SOP-CR-026_01" description="01 May 2025">
  New SOP. Content split from SOP-CR-007_07 and updated with N2 SOP007_10 information. Clarifications and additions include sections 5.1.1–5.1.3, 5.1.5, 5.1.7, 5.2.1–5.2.5, 5.3.1–5.4.3, 5.5.2–5.6.4, 5.7, 5.9, and 5.10. Added Appendix 2 (CAPA Form).
</Update>
