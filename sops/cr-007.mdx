...
This SOP describes the required documentation and communication for initial study submission between the Sponsor-Investigator or QI/PI and the MUHC Research Ethics Board (REB)/Scientific Review. It also describes the institutional feasibility review to obtain MUHC Authorization, requirements for Annual Continuing REB approval, Conflict of Interest (COI) reporting, and clinical trial registration on clinicaltrials.gov.

This SOP applies to research community members involved in the initial study submission and annual renewal processes for studies not already reviewed by an REB from a different RSSS site. For ongoing review of amendments and reportable events, see SOP-CR-026.
...
| Role | Responsibility |
|---|---|
| **Sponsor / Sponsor-Investigator** | Ensure Health Canada approval (if required) is obtained before study start. Register the clinical trial before recruiting the first participant. Secure agreements and ensure direct access to TMF/ISF for monitoring. |
...
| **QI/PI / REB Lead** | Submit all required documents in Nagano. Ensure Privileges/Researcher Status and institutional training are obtained. Ensure the study does not begin before all required approvals are in hand. Submit annual renewals before approval expires. |
| **MUHC REB** | Conduct scientific and ethical review of the study. Approve or refuse. Issue an REB approval letter. |
| **Personne mandatée (MUHC Authorization)** | Formally attest through an authorization letter that the project has undergone scientific review, ethics review, and site-specific assessment with positive results. |
...
**5.1.1 Health Canada approval:** For any human research trial involving an investigational new drug (Phase I, II, III, or IV with conditions), natural health product, or Class II/III/IV new medical device, the Sponsor must obtain Health Canada approval before conducting human research. → SOP-CR-018 (drugs), SOP-CR-023 (NHPs), SOP-CR-024 (medical devices). The NOL/NOA/ITA must be forwarded to Investigators for filing in the ISF and submitted to the REB.
...
**5.1.4** No Investigator may begin recruiting participants before REB approval and institutional authorization. Best practice: ship materials and conduct the SIV after initial REB approval and MUHC Authorization.

**5.1.5** At SIV, ensure only appropriately qualified and trained team members are delegated tasks on the Task Delegation Log.

**5.1.6** Conduct QC and file all essential documents in the Trial Master File (TMF) — per ICH-GCP section 8 for drug/NHP studies, or ISO-GCP Annex E for medical device studies.
...
- Obtain Privileges or Researcher Status (→ SOP-CR-500) and the appropriate level of institutional training (→ SOP-CR-003)
- Obtain Nagano training and document it
- Ensure the protocol and Investigator Brochure are the most recent versions
- Prepare ICFs and recruitment materials per SOP-CR-006
- Submit the site-specific ICF to the Sponsor/Sponsor-Investigator for approval before REB submission

**5.2.2** Refer to the MUHC REB webpages for submission platform access and appropriate forms.

**5.2.3** The REB Lead/Investigator creates an account in Nagano and completes the initial study submission. Depending on the study type, additional forms may be triggered (Department Head signature, nursing, laboratory, pharmacy agreement, EFVP form for privacy). When a delegate submits on behalf of the Investigator, the "Principal Investigator's Commitment and Signature" form must be completed.
...
**5.2.7** File all REB submissions, approvals, acknowledgments, and correspondence in the ISF/TMF. → SOP-CR-015
...
**5.4.2 QA feasibility review (Privileges and training):** QA confirms the QI/PI holds valid RI-MUHC Privileges or Researcher Status (→ SOP-CR-500) and the appropriate level of institutional training (→ SOP-CR-003). If training is insufficient, the personne mandatée will not provide MUHC Authorization.
...
- A lapse should be documented on the Protocol/GCP/SOP Deviation Log → SOP-CR-026
...
For multi-centrique trials: the REB Lead site submits on behalf of all participating Quebec RSSS sites. Participating sites that are Nagano users submit directly; non-Nagano sites send submissions to the RI-MUHC CRC for the study. All requests to add sites must be submitted via Nagano.
...
- Quebec Law 25 (Act to modernize legislative provisions regarding protection of personal information)
...
<Update label="SOP-CR-007_08" description="01 May 2025">
  N2 SOP-CR-007_10 and RI-MUHC Addendum combined and clarified. SOP-CR-007 split into SOP-CR-007 (initial submission and annual renewal) and SOP-CR-026_01 (ongoing review and reportable events). Revision/addition to sections 5.1.1, 5.1.2, 5.1.6, 5.1.7, 5.2, 5.3.2, 5.4.1, 5.4.2–5.4.12, 5.5.4, 5.6, 5.7.2, 5.7.3, and 5.8.
</Update>
