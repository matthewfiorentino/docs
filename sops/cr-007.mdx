...
This SOP applies to research community members involved in the initial study submission and annual renewal processes for studies not already reviewed by an REB from a different RSSS site. For ongoing review of amendments and reportable events, see [SOP-CR-026](/sops/cr-026).
...
**5.1.1 Health Canada approval:** For any human research trial involving an investigational new drug (Phase I, II, III, or IV with conditions), natural health product, or Class II/III/IV new medical device, the Sponsor must obtain Health Canada approval before conducting human research. → [SOP-CR-018](/sops/cr-018) (drugs), [SOP-CR-023](/sops/cr-023) (NHPs), [SOP-CR-024](/sops/cr-024) (medical devices). The NOL/NOA/ITA must be forwarded to Investigators for filing in the ISF and submitted to the REB.
