...
This SOP describes the process of recruitment, screening, and enrollment of participants for a human research study at the MUHC/RI-MUHC, within the framework of ICH-GCP and ISO-GCP principles and all applicable guidelines and regulations.
...
The Sponsor/Sponsor-Investigator and QI/PI are responsible for ensuring that the participant recruitment, screening, and enrollment processes meet all applicable regulatory, ICH-GCP, ISO-GCP, Sponsor, Health Canada, and local requirements, including:
- Ensuring all recruitment tools and advertisements in any medium are REB approved before use; patient-facing advertisements must also be approved by MUHC Communications before use
- Ensuring informed consent is obtained from every participant before screening (unless an REB consent waiver and EFVP review are in place) → SOP-CR-008
...
**5.1.1** The Sponsor, QI/PI, CRC, or delegate develops a study-specific recruitment plan before study initiation.
...
**5.1.7–5.1.8** Develop recruitment materials and submit to the Sponsor or Sponsor-Investigator, then the REB (via Nagano), and then MUHC Communications. All advertisements in any medium must meet the following requirements:
...
**5.2.3** File REB approval of recruitment materials in the ISF. Implement recruitment only after REB approval, MUHC Authorization, and the Sponsor/Sponsor-Investigator's Go Letter/email have been received.

**5.2.4** Submit any amendments to recruitment materials to the REB per SOP-CR-026. Ensure version numbers are on all documents and file names. Obtain approvals before use and document on the REB Approval Tracking Log.
...
|---|---|---|---|
| **Screening Log** (Appendix 3) | Identifies all screened participants | Screening number, ICF date, reason for screen failure | Participant IDs only — no nominative information |
...
**5.6.2** Obtain written informed consent from every participant before starting any screening activities, using the latest REB-approved ICF. → SOP-CR-008
...
For studies involving an Investigational Product (drug, NHP, or medical device):
...
<Update label="SOP-CR-009_08" description="01 May 2025">
  Conversion to RI-MUHC SOP format. Addition/revision to sections 5.1.7, 5.1.8, 5.2.2–5.4.1, 5.4.4, 5.6.5, 5.6.6, 5.7.2, 5.7.4, 5.8.6, and 5.11.8. Reference to SOP-CR-026 added.
</Update>
