...
<Steps>
  <Step title="Obtain Research Privileges or Researcher Status">
    The QI/PI must hold current RI-MUHC Privileges (for MDs and dentists) or Researcher Status (for non-MDs) before a study can be submitted. Apply via TalentLMS. See [SOP-CR-500](/sops/cr-500) and the [Investigator Orientation](/kb/roles/pi-orientation) for eligibility details.
  </Step>
