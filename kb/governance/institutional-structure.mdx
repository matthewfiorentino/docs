...
Clinical research at the RI-MUHC requires two independent approvals before a single participant can be enrolled: ethics and scientific review by the REB, and institutional authorization by the Personne mandatée. Understanding who is involved, what each review covers, and how they connect is the foundation for navigating the research process at the MUHC.
...
- The **RI-MUHC** sets the research policies, maintains the SOPs, manages investigator credentials (Privileges and Researcher Status), and provides Quality Assurance oversight.
...
The REB reviews the scientific merit and ethical acceptability of research involving human participants. It assesses the protocol, informed consent form, recruitment materials, and all participant-facing documents.
...
QA performs the institutional feasibility check when a new study is submitted in Nagano. This check confirms three things before the study can proceed to MUHC Authorization:

- The QI/PI or Sponsor-Investigator holds valid Human Research Privileges or Researcher Status
...
<Tabs>
  ...
  <Tab title="Human Researcher Status (Path B)">
    ...
    **Pharmacist exception:** Although pharmacists are CPDP members, they are not eligible for Human Research Privileges under MSSS and MUHC frameworks. Pharmacists acting as PI or Sub-Investigator backup must obtain Human Researcher Status (Path B).
  </Tab>
</Tabs>
