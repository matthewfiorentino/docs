...
<Steps>
  ...
  <Step title="Identify the root cause">
    ...
    **Fishbone analysis — same dosing error, by category:**

    | Category | Contributing factors |
    |---|---|
    | **People** | CRC-N new to study; no second-person verification step for dosing |
    | **Process** | Shared dosing log for all participants; no individual dosing worksheet template |
    | **Environment** | Busy clinic day with multiple participants dosed; dosing area shared with other studies |
    | **Equipment / Materials** | Dosing chart format unclear; no visual separator between participant rows |

    → **Effect:** Wrong IP dose administered
