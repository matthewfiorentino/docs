...
#rc-root .rc-bar-label { font-size: 12px; font-weight: 600; color: var(--textm); width: 130px; flex-shrink: 0; text-align: right; }
#rc-root .rc-bar-track { flex: 1; height: 24px; background: var(--bg); border-radius: 4px; position: relative; overflow: visible; }
#rc-root .rc-bar-fill { height: 100%; border-radius: 4px; position: relative; transition: width .4s ease; max-width: 100%; }
...
#rc-root .rc-bar-val { position: absolute; right: -52px; top: 50%; transform: translateY(-50%); font-size: 12px; font-weight: 700; white-space: nowrap; color: var(--textm); }
