...
After the sponsor selects your site following the [feasibility assessment](/kb/planning/feasibility), several things happen before the study can be formally submitted through <Tooltip tip="The RI-MUHC's electronic study submission and management platform. All studies requiring MUHC Authorization are submitted through Nagano." headline="Nagano (RI-MUHC)" cta="Full definition" href="/kb/foundations/glossary#nagano">Nagano</Tooltip>.
...
|---|---|
| Facilities | Clinic space, pharmacy, lab, <Tooltip tip="A drug, medical device, or natural health product being tested or used as a reference in a clinical trial." headline="Investigational Product (IP)" cta="Full definition" href="/kb/foundations/glossary#ip">IP</Tooltip> storage capacity, patient flow |
| Personnel | <Tooltip tip="The physician responsible to the sponsor for the conduct of a clinical trial at the site. One QI per study per Canadian site." headline="Qualified Investigator (QI)" cta="Full definition" href="/kb/foundations/glossary#qi">QI</Tooltip>/PI and key staff availability, therapeutic area experience, <Tooltip tip="International standard for design, conduct, monitoring, recording, and reporting of clinical studies." headline="Good Clinical Practice (GCP)" cta="Full definition" href="/kb/foundations/glossary#gcp">GCP</Tooltip> training currency |
| Regulatory readiness | Current <Tooltip tip="The ethics committee that reviews and approves research involving human participants. Also called CER at French-language institutions." headline="Research Ethics Board (REB)" cta="Full definition" href="/kb/foundations/glossary#reb">REB</Tooltip> workload and timelines, delegation and training documentation systems |
...
<Tabs>
  ...
  <Tab title="Common delays to anticipate">
    ...
    - **Contract negotiation** — budget and CTA negotiations can take weeks to months. Engage [Finance](/kb/funding/budgets-contracts) early and flag complex indemnification or IP clauses to the Research Agreements Office.
    ...
    - **Staff availability** — if a key team member (QI/PI, <Tooltip tip="The team member who handles day-to-day administration and coordination of the clinical trial." headline="Clinical Research Coordinator (CRC)" cta="Full definition" href="/kb/foundations/glossary#crc">CRC</Tooltip>, research nurse) is unavailable for the SIV window, the entire timeline shifts.
  </Tab>
</Tabs>

Contract and budget negotiation runs in parallel or follows the qualification visit — see [Study Budgets and Agreements](/kb/funding/budgets-contracts) and [Negotiating an Industry-Sponsored Budget](/kb/funding/budget-negotiation). Contract execution is a prerequisite for MUHC Authorization.
...
flowchart TD
    ...
    style HC  fill:#2b9ce2,color:#fff,stroke:none
    style REB fill:#2b9ce2,color:#fff,stroke:none
    style MUHCF fill:#2b9ce2,color:#fff,stroke:none
    style AUTH fill:#2b9ce2,color:#fff,stroke:none
    style SIV  fill:#2b9ce2,color:#fff,stroke:none
    style GO   fill:#2b9ce2,color:#fff,stroke:none
    style GATE fill:#1a1466,color:#fff,stroke:none
    style FP   fill:#2b2666,color:#fff,stroke:none
    style BLOCK fill:#ff6b6b,color:#fff,stroke:none
```

<Steps>
  <Step title="Health Canada authorization (drug and device studies only)">
    <Tooltip tip="Letter from Health Canada confirming a CTA is satisfactory and authorizing the sponsor to proceed." headline="No Objection Letter (NOL)" cta="Full definition" href="/kb/foundations/glossary#nol">No Objection Letter</Tooltip> (NOL) for drug studies, Notice of Authorization (NOA) for natural health products, or <Tooltip tip="Health Canada authorization to conduct a clinical investigation of a medical device. The device equivalent of a CTA." headline="Investigational Testing Authorization (ITA)" cta="Full definition" href="/kb/foundations/glossary#ita">Investigational Testing Authorization</Tooltip> (ITA) for medical devices. Runs in parallel with Nagano submission. Must be received before <Tooltip tip="Institutional authorization allowing a study to proceed at the RI-MUHC. Issued after ethics approval and feasibility review." headline="MUHC Authorization" cta="Full definition" href="/kb/foundations/glossary#muhc-auth">MUHC Authorization</Tooltip> can be granted.
  </Step>
  <Step title="REB review and institutional feasibility (parallel tracks via Nagano)">
    REB scientific and ethics review runs in parallel with the MUHC institutional feasibility review (<Tooltip tip="All planned and systematic actions to ensure trial data are generated, documented, and reported in compliance with GCP and SOPs." headline="Quality Assurance (QA)" cta="Full definition" href="/kb/foundations/glossary#qa">QA</Tooltip>, pharmacy, nursing, laboratory, contracts, Director of Professional Services). Both must be complete and satisfactory before the <Tooltip tip="Individual formally authorized to issue the final written authorization for each research project at a Quebec RSSS institution." headline="Personne mandatée (PFM)" cta="Full definition" href="/kb/foundations/glossary#personne-mandatee">Personne mandatée</Tooltip> can issue MUHC Authorization.
  </Step>
  ...
  <Step title="Site Initiation Visit (SIV)">
    The Sponsor or Monitor conducts the SIV after MUHC Authorization is confirmed. The SIV provides protocol-specific training to the full research team and results in the <Tooltip tip="Lists each team member, their qualifications, and specific trial tasks authorized by the QI." headline="Task Delegation Log (TDL)" cta="Full definition" href="/kb/foundations/glossary#tdl">Task Delegation Log</Tooltip> being signed. No protocol activities — including screening — may begin before the SIV.
  </Step>
  <Step title="Sponsor's Go Letter → first participant may be approached">
    The Sponsor's Go Letter confirms that the site is ready to enrol. Once received and filed, the study is fully activated. For Sponsor-Investigator studies where the QI/PI is also the Sponsor, a separate Go Letter may not be required.
  </Step>
</Steps>
...
Before the SIV can be scheduled, several prerequisite documents must be in place in the ISF and <Tooltip tip="The sponsor's collection of documentation demonstrating compliance across all study sites." headline="Trial Master File (TMF)" cta="Full definition" href="/kb/foundations/glossary#tmf">TMF</Tooltip>: the Health Canada authorization (where applicable), REB approval for the protocol and all participant-facing materials, the executed Clinical Trial Agreement, the signed protocol, the signed <Tooltip tip="Compilation of clinical and nonclinical data on the investigational product relevant to the study." headline="Investigator's Brochure (IB)" cta="Full definition" href="/kb/foundations/glossary#ib">Investigator's Brochure</Tooltip>, and CVs and licences for all team members who will be delegated tasks.
...
- IP management, including pharmacy
- <Tooltip tip="Any untoward medical occurrence in a participant, whether or not related to the investigational product." headline="Adverse Event (AE)" cta="Full definition" href="/kb/foundations/glossary#ae">Adverse event</Tooltip> reporting
- <Tooltip tip="Document designed to record all protocol-required information to be reported to the sponsor for each participant." headline="Case Report Form (CRF)" cta="Full definition" href="/kb/foundations/glossary#crf">CRF</Tooltip> completion
...
<Tabs>
  ...
  <Tab title="After the SIV">
    After the SIV, the Sponsor or Monitor writes the SIV report confirming the site has been trained on all study aspects and GCP requirements. The completed and signed SIV report is sent to the site for review and filing in the ISF. The site must file the SIV report, the Training Log, and all SIV training slides. All team members trained at the SIV are then added to the Task Delegation Log with the QI/PI's signature.
  </Tab>
</Tabs>
...
|---|---|---|
| 1 | REB written approval | Ethics and scientific review is complete. The REB has confirmed the study is ethical, the <Tooltip tip="The written document providing the participant with information essential to making an informed decision. Both parties must sign." headline="Informed Consent Form (ICF)" cta="Full definition" href="/kb/foundations/glossary#icf">ICF</Tooltip> is adequate, and participant rights will be protected. |
...
<AccordionGroup>
  ...
  <Accordion title="Team qualifications">
    ...
    - SOP Reader and Assessment certificates (TalentLMS)
  ...
  <Accordion title="Study activation documents">
    ...
    - SIV training slides
    - Monitoring Log (signed by monitor and CRC at SIV)
...
| <Tooltip tip="US equivalent of the Canadian Qualified Investigator (QI)." headline="Principal Investigator (PI)" cta="Full definition" href="/kb/foundations/glossary#pi">PI</Tooltip>-initiated studies funded by industry | 30% |
...
- [Recruitment, Screening, and Enrollment](/kb/recruitment/recruitment-enrollment) — recruitment planning, screening, enrollment procedures
- [Building Your Research Team](/kb/team/building-your-team) — delegation, training, and team composition
- [Study Planning Overview](/kb/planning/planning-overview) — planning timeline, activation targets, regulatory tracks
- [SOP-CR-004 — Protocol Feasibility and Site Selection](/sops/cr-004) — feasibility assessment checklist and process
