...
<Note>
  **Before you submit: confirm this is research.** Quality assurance and quality improvement (QA/QI) projects are exempt from REB review under [TCPS2 Article 2.5](https://ethics.gc.ca/eng/tcps2-eptc2_2022_chapter2-chapitre2.html) and follow a different path — they go to the [Centre for Applied Ethics](mailto:cae@muhc.mcgill.ca) for an exemption letter, not to the REB via Nagano. If you have not already, use the [Is It Research?](/kb/is-it-research) screening tool to determine which path applies.
</Note>
