...
<Tabs>
  <Tab title="PI-initiated study">
    ...
    **First steps:**
    ...
    - If your study needs dedicated clinical infrastructure — Phase I unit, oncology infusion, IV administration, functional testing, or specimen processing — or research nursing, coordination, or monitoring support, contact the [Centre for Innovative Medicine (CIM)](/cim/planning) during planning. CIM also provides monitoring for Sponsor-Investigator studies. Engage early: Phase I capacity is limited and CIM costs must be in your budget before the Site Agreement is signed.
  ...
  <Tab title="Sponsor-initiated study">
    ...
    **The selection process:** feasibility questionnaire → pre-study site visit → site selection → contract and budget negotiation → activation.
    ...
    Many industry-sponsored studies at the MUHC are operated through the [Centre for Innovative Medicine (CIM)](/cim/planning). CIM provides research nursing, coordination, regulatory support, budget negotiation, and — for Phase I and oncology — dedicated clinical infrastructure. If you are considering CIM for your study, engage them before responding to the feasibility questionnaire so their capacity and costs are reflected from the outset.
