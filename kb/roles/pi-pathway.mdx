...
<Tabs>
  ...
  <Tab title="Sponsor-initiated study">
    ...
    **The selection process:** feasibility questionnaire → pre-study site visit → site selection → contract and budget negotiation → activation. If you are considering having the study operated through the CIM, engage them before responding to the feasibility questionnaire.
