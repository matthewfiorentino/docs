...
As PI or Qualified Investigator, you carry ultimate legal and regulatory accountability for your study at the RI-MUHC site. Tasks can be delegated — accountability cannot. This page maps your obligations from prerequisites through close-out and links to the companion guides that give you the operational detail for your study type.
...
<Tabs>
  <Tab title="Interventional I — Drug">
    **Level I** covers drug trials (biologics, vaccines, gene/cell therapies) under a Clinical Trial Application.

    | Requirement | Details |
    |---|---|
    | SOP series | SOP-CR (31 SOPs) |
    | SOP renewal | Every 2 years |
    | GCP | ICH-GCP required (CITI licence free for RI-MUHC staff) |
    | Health Canada Division 5 | Required |
    | Human Research Privileges | Required |
  </Tab>
  <Tab title="Interventional II — Device">
    **Level II** covers medical device and surgical studies under an Investigational Testing Authorization.
  ...
  <Tab title="Retrospective V">
    **Level V** covers retrospective chart reviews and studies using biobanked samples. Consent waiver decisions depend on the ÉFVP outcome.
...
<AccordionGroup>
  <Accordion title="QIU form (Level I drug trials only)">
    You sign the Qualified Investigator Undertaking before the study begins, confirming you will conduct the trial per Health Canada regulations and GCP. Do not sign FDA Form 1572 — use the RI-MUHC ICH GCP Attestation form (SOP-CR-002 Appendix 4) if a US Sponsor requires the equivalent.
  </Accordion>
  ...
  <Accordion title="Medical oversight of safety documents">
    You review and initial all AE documentation, SAE reports, SUSAR reports, lab results, and any document requiring medical assessment. This is ongoing throughout the study and cannot be fully delegated — a qualified Sub-I may be delegated AE causality assessment, but that delegation must appear on the log.
  </Accordion>
  ...
  <Accordion title="PI Commitment and Signature in Nagano">
    Your CRC can prepare the entire F11 submission — but it is not complete until you complete the final commitment and signature step in Nagano. The same applies to annual renewals and amendments.
  </Accordion>
</AccordionGroup>

The following items are prepared by your team but still require your review and sign-off before submission:

- **Annual REB renewal** — your CRC prepares the submission; you review and sign off in Nagano. Submit before approval lapses — a lapse halts the study.
...
<Steps>
  <Step title="Set up the Task Delegation Log before any study tasks begin">
    Name every team member, their role, their specific delegated tasks, and their start date. You countersign each entry. Team members sign to accept delegation. See [SOP-CR-002](/sops/team-governance) and [Building Your Research Team](/kb/planning/overview).
  </Step>
  ...
  <Step title="File CVs and training certificates in the ISF">
    Every team member's current CV (signed, dated within the past 2 years) and all training certificates must be filed before the Site Initiation Visit. Do not include personal information (home address, family details) in CVs filed in study documents.
  </Step>
...
- **Document the consent process in the source record** — who conducted the discussion, when, that the participant had adequate time, and that questions were answered. The ICF signature alone is not sufficient.
...
<Note>
  **Before extended absence:** appoint a Sub-I backup with Privileges or Researcher Status, update the delegation log and Nagano. SOP-CR-002 recommends writing a department-specific working instruction describing how QI/PI oversight is achieved for your team.
</Note>
...
Under Quebec's Loi 25, the ÉFVP (privacy impact assessment) may be required before data collection begins. This applies to most prospective studies and to any study where data is shared outside the MUHC. For retrospective studies, the ÉFVP outcome determines whether a consent waiver is granted.
...
Review and sign off on the completed ISF before the Sponsor's Close-Out Visit. Ensure all monitoring letters are initialled, all CRF corrections are complete, and the delegation log has end dates for all team members.
