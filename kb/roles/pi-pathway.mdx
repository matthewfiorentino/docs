...
Research integrity is not a separate compliance obligation — it is the condition under which everything else in clinical research is valid. As PI, you are responsible for ensuring honest, rigorous, and transparent conduct by everyone on your team throughout the study lifecycle.
