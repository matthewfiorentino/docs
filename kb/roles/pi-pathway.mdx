...
The diagram below shows where your personal signature is required across the study lifecycle:
...
flowchart LR
    subgraph PRE["Pre-submission"]
        S1["QIU<br/>Drug Lvl I"]
        S2["F11 PI<br/>commitment"]
    end
    subgraph ACT["Activation"]
        S3["Task<br/>Delegation Log"]
        S4["Protocol +<br/>IB signature"]
    end
    subgraph CON["Conduct"]
        S5["AE / SAE / SUSAR<br/>medical assessment"]
        S6["Monitoring<br/>follow-up letters"]
        S7["Amendments<br/>F1 form"]
        S8["Annual REB<br/>renewal"]
    end
    subgraph EVT["Reportable events"]
        S9["Deviation<br/>reports"]
        S10["CAPA<br/>sign-off"]
    end
    subgraph CO["Close-out"]
        S11["Closure of<br/>Research Project"]
        S12["Final report<br/>+ archiving"]
    end

    PRE --> ACT --> CON --> EVT --> CO

    style PRE fill:#f5f5fa,color:#150e51,stroke:#150e51
    style ACT fill:#f5f5fa,color:#150e51,stroke:#150e51
    style CON fill:#f5f5fa,color:#150e51,stroke:#150e51
    style EVT fill:#f5f5fa,color:#150e51,stroke:#150e51
    style CO fill:#f5f5fa,color:#150e51,stroke:#150e51

    style S1 fill:#150e51,color:#fff,stroke:none
    style S2 fill:#150e51,color:#fff,stroke:none
    style S3 fill:#007a6e,color:#fff,stroke:none
    style S4 fill:#007a6e,color:#fff,stroke:none
    style S5 fill:#ff6b6b,color:#fff,stroke:none
    style S6 fill:#007a6e,color:#fff,stroke:none
    style S7 fill:#007a6e,color:#fff,stroke:none
    style S8 fill:#f59e0b,color:#fff,stroke:none
    style S9 fill:#f59e0b,color:#fff,stroke:none
    style S10 fill:#f59e0b,color:#fff,stroke:none
    style S11 fill:#00c4b4,color:#150e51,stroke:none
    style S12 fill:#00c4b4,color:#150e51,stroke:none
```
