...
|---|---|---|
| **CIHR** (Canadian Institutes of Health Research) | Health research across all disciplines | Project Grant, Team Grant, SPOR grants |
| **FRQ** (Fonds de recherche du Québec) | Quebec researchers across sectors — the three former funds (FRQS, FRQSC, FRQNT) merged into FRQ in June 2024 | Chercheur-boursier career awards (FRQS sector), Clinical Research Scholars, Research Support for New Academics (FRQSC sector) |
| **NSERC** | Natural sciences and engineering; relevant for biomedical engineering, devices | Discovery Grants, Alliance Grants |
...
### CORD (Clinical and Observational Research Data)
