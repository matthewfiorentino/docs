...
<Note>
  The [Research Facilitator](mailto:Research.facilitator@muhc.mcgill.ca) and the Pre-Awards Office can review your KMb plan before submission. For patient-oriented research, see [Patient Engagement in Research](/kb/patient-engagement) for guidance on structuring iKT partnerships.
</Note>
...
- [Study Budgets and Agreements](/kb/budgets-contracts) — institutional overhead schedule, REB fees
- [Biostatistics Consulting Unit (BCU)](/kb/bcu) — methodological support for applications
- [Capture and Optimization of Research Data (CORD)](/kb/cord) — data management plans and REDCap support
...
- [Patient Engagement in Research](/kb/patient-engagement) — iKT partnerships and patient partner involvement
