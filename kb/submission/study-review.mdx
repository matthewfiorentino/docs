...
<AccordionGroup>
  <Accordion title="Approved">
    Your study is approved as submitted. Valid for up to one year — renewal must be submitted before expiry. All research activities must cease if the approval lapses, except continuing research-related medical treatment already underway where necessary to protect participant safety, with immediate notification to the REB. File the approval letter in the ISF the day you receive it and calendar your annual renewal immediately.
  </Accordion>
...
|---|---|
| Annual REB renewal | Authorization is automatically revalidated with each successful REB renewal. All activities must cease if renewal lapses, except continuing research-related medical treatment already underway where necessary to protect participant safety, with immediate REB notification. |
