...
<Steps>
  <Step title="Obtain Research Privileges or Researcher Status">
    The QI/PI must hold current RI-MUHC Privileges (for MDs and dentists) or Researcher Status (for non-MDs) before a study can be submitted. Apply via TalentLMS. See [SOP-CR-500](/sops/cr-500) and the [PI Training Pathway](/kb/roles/pi-pathway) for eligibility details.
  </Step>
  ...
  <Step title="Confirm your team">
    Identify all team members and appoint a qualified Sub-Investigator as QI/PI backup. The backup must hold the same Privileges or Researcher Status as the QI/PI — fellows and residents are not eligible as backup. Confirm that all team members have completed institutional training at the appropriate level. See [Team Management During a Study](/kb/conduct/site-setup) and [SOP-CR-002](/sops/cr-002).
  </Step>
