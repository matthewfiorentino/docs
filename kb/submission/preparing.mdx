...
<Steps>
  ...
  <Step title="Complete the ÉFVP form (if applicable)">
    If your study requires access to identifiable personal health information without participant consent, complete the relevant ÉFVP form (F17 or F18) in Nagano as part of the initial submission. See [Submitting via Nagano](/kb/submission/submitting-via-nagano) for guidance on which form applies.
  </Step>
