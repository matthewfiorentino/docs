...
For guidance on which form applies, see [Submitting via Nagano](/kb/submission/submitting-via-nagano). For questions about scope, contact the ÉFVP committee at [EFVP@muhc.mcgill.ca](mailto:EFVP@muhc.mcgill.ca).
