...
Privacy obligations in clinical research at the MUHC arise from four overlapping layers. The international and federal layers are addressed in GCP training. This page covers the two that are not: Quebec provincial law and MUHC institutional policy.
...
The agreement is included as Appendix 1 of SOP-CR-019. It must be signed and submitted to MUHC Medical Records Services before that person is granted access to patient records. The requirement applies to everyone on the Task Delegation Log whose study tasks involve any access to identifiable participant information — including CRCs, research nurses, sub-investigators, and data entry staff.
...
**Data collected only for approved purposes** — Data may be collected and used only for the REB-approved study. Accessing participant records for purposes beyond the approved study scope is a privacy violation regardless of whether the researcher has clinical access to those records in their treating role.
...
Separately, the research team is responsible for retaining the essential study documents in the ISF/TMF for a minimum of 15 years from study closure for Health Canada-regulated studies, or 7 years for non-regulated studies. This obligation rests with the QI/PI and is governed by SOP-CR-015.
