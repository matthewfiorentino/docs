...
- [Monitoring, Audits, and Inspections](/kb/conduct/monitoring-audits) — monitoring expectations during and after close-out
- [Reportable Events and Protocol Deviations](/kb/conduct/reportable-events) — resolving open deviations before closure
- [Multi-Centric Studies in Quebec](/kb/planning/multi-centric) — multi-site closure sequencing requirements
