...
Regulated under Health Canada's Investigational Testing Authorization (ITA) process. Device handling, storage, and accountability follow device-specific procedures. See [SOP-CR-024](/sops/cr-024) for the RI-MUHC framework.
</Accordion>
