...
| [ICH GCP E6(R2)](https://www.ich.org/page/efficacy-guidelines) | International GCP standards for clinical trials |
...
flowchart TD
    ...
    style L fill:#00c4b4,color:#fff,stroke:none
```
...
- RI-MUHC SOP training records (the All-in-One Human Research SOP is available for download from TalentLMS)
...
- Any <Tooltip tip="Document designed to record all protocol-required information to be reported to the sponsor for each participant." headline="Case Report Form (CRF)" cta="Full definition" href="/kb/glossary#crf">CRF</Tooltip>s and Data Clarification Forms (DCFs) — verify all CRF entries and resolve any queries. After study closure, CRFs should be signed by the QI
...
- **Critical (Risk 1)** — Life-threatening risks, or conditions likely to compromise trial data integrity
- **Major (Risk 2)** — Significant deviations that could expose participants to health risks or affect data validity
- **Minor (Risk 3)** — Deficiencies indicating deviation from regulations but with less severe consequences
...
See [Monitoring, Audits, and Inspections](/kb/conduct/monitoring-audits) for finding classification definitions.
...
- [Monitoring, Audits, and Inspections](/kb/conduct/monitoring-audits) — inspection types, finding classifications, and how inspections are triggered
