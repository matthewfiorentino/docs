...
| Consent waiver — records-based research | The REB may grant a waiver of consent for retrospective or records-based research. When health records are accessed without consent, an EFVP must be submitted. See [Privacy and Confidentiality in Quebec](/kb/conduct/privacy) for the EFVP framework. |
...
- [Privacy and Confidentiality](/kb/conduct/privacy) — confidentiality agreements, data access controls
- [Reportable Events and Protocol Deviations](/kb/conduct/reportable-events) — when a consent deviation triggers re-consent
