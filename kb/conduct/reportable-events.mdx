...
<CardGroup cols={3}>
  <Card title="Minor" icon="circle-info">
    ...
    **Action:** Log deviation and notify Sponsor. Report to REB at annual Continuing Review. No CAPA required — document and review for trends.
  </Card>
  <Card title="Major" icon="triangle-exclamation">
    ...
    **Action:** CAPA required. Report to REB within **15 days** (or **7 days** if life-threatening). Copy CAPA to QA and notify Sponsor.
  </Card>
  <Card title="Critical" icon="circle-exclamation">
    ...
    **Examples:** Unapproved IP administered; safety event concealed from the REB; data fabricated or altered to conceal a violation.
