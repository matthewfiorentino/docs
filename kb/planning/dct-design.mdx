...
For multi-site studies within Quebec's <Tooltip tip="Quebec's public health and social services network (Réseau de la santé et des services sociaux), including the RI-MUHC." headline="RSSS" cta="Full definition" href="/kb/glossary#rsss">RSSS</Tooltip> network, see [Multi-Centric Studies in Quebec](/kb/planning/multi-centric).
...
- [Recruitment, Screening, and Enrollment](/kb/conduct/recruitment-enrollment) — recruitment planning, pre-screening EFVP requirements
- [Informed Consent in Quebec](/kb/conduct/consent) — ICF requirements, e-consent considerations, vulnerable populations
