...
Planning is the most consequential phase of a clinical study. Decisions made here — about design, team, data, regulatory pathway, and funding — determine whether a study can be submitted, approved, and successfully conducted at The Institute. This section covers everything you need to work through before submitting via <Tooltip tip="The RI-MUHC's electronic study submission and management platform. All studies requiring MUHC Authorization are submitted through Nagano." headline="Nagano (RI-MUHC)" cta="Full definition" href="/kb/foundations/glossary#nagano">Nagano</Tooltip>.

<Note>
  **Before anything else: is your project research?** Some chart reviews, process audits, and evaluations of standard care qualify as QA/QI under [TCPS2 Article 2.5](https://ethics.gc.ca/eng/tcps2-eptc2_2022_chapter2-chapitre2.html) and are exempt from REB review. Use the [Is It Research?](/is-it-research) screening tool to confirm before investing in study planning.
</Note>

## Planning pathway

All studies at the MUHC follow the same broad arc: the research question and design are established, the team and operational elements are put in place, and the study is prepared for submission. The two most common starting points — <Tooltip tip="US equivalent of the Canadian Qualified Investigator (QI)." headline="Principal Investigator (PI)" cta="Full definition" href="/kb/foundations/glossary#pi">PI</Tooltip>-initiated and sponsor-initiated — converge before submission.
...
flowchart TD
    ...
    style PI   fill:#2b9ce2,color:#fff,stroke:none
    style SP   fill:#1a1466,color:#fff,stroke:none
    style GATE fill:#2b9ce2,color:#fff,stroke:none
...
See [Design Stage Support](/kb/design-support/study-design) for the full list of planning specialists and who to contact at each stage.
...
- [Study Budgets and Agreements](/kb/funding/budgets-contracts) — clinical trial agreements, budget templates, and the Research Agreements Office
- [Managing Study Funds](/kb/funding/research-grants) — research accounts, overhead rates, and financial reporting
- [Regulations and Guidelines](/kb/planning/regulations) — Health Canada CTA/ITA requirements and the full regulatory framework

For the complete pre-submission checklist — privileges, training, documents, contracts, and privacy requirements — see [Preparing Your Submission](/kb/submission/preparing).
...
| Industry-sponsored (site joining) | 3–9 months | Contract negotiation, <Tooltip tip="Monitoring visit to train the site team on the protocol and confirm site readiness, after REB approval and MUHC Authorization." headline="Site Initiation Visit (SIV)" cta="Full definition" href="/kb/foundations/glossary#siv">SIV</Tooltip> scheduling, Sponsor go-letter |
...
- [Study Conduct Overview](/kb/conduct/conduct-overview) — what happens after activation: consent, visits, oversight, close-out
...
- [My Study Roadmap](/my-roadmap) — personalized phase-by-phase plan for new studies at the RI-MUHC
