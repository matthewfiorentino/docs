...
<Steps>
  <Step title="Privileges and training">
    The PI must hold active Human Research Privileges or Researcher Status at the RI-MUHC. All team members on the Task Delegation Log must hold current training: SOP Reader, <Tooltip tip="International standard for design, conduct, monitoring, recording, and reporting of clinical studies." headline="Good Clinical Practice (GCP)" cta="Full definition" href="/kb/glossary#gcp">GCP</Tooltip> (CITI), Division 5 (drug trials), ISO 14155 (device trials).
  </Step>
  <Step title="Protocol and consent">
    Final protocol, <Tooltip tip="The written document providing the participant with information essential to making an informed decision. Both parties must sign." headline="Informed Consent Form (ICF)" cta="Full definition" href="/kb/glossary#icf">informed consent form</Tooltip>(s) in required languages, and any sponsor-provided study documents.
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Submission and Review" icon="arrow-right" href="/kb/submission/overview">
    When you're ready: the three review streams, what <Tooltip tip="Institutional authorization allowing a study to proceed at the RI-MUHC. Issued after ethics approval and feasibility review." headline="MUHC Authorization" cta="Full definition" href="/kb/glossary#muhc-auth">MUHC Authorization</Tooltip> means, and how to submit via Nagano.
  </Card>
</CardGroup>
