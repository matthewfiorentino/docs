---
title: "Protocol Deviations and Corrective Actions"
...
Reporting obligations for deviations — the classification thresholds, REB timelines, and Deviation Log requirements — are covered in [Reportable Events and Protocol Deviations](/kb/reportable-events). This page covers the operational side: how to classify ambiguous cases, how to work through a CAPA, and how to prevent the most common deviations from occurring in the first place.
...
A <Tooltip tip="Actions taken to resolve a compliance issue and prevent recurrence: identify, correct, prevent." headline="Corrective and Preventive Action (CAPA)" cta="Full definition" href="/kb/glossary#capa">CAPA</Tooltip> is required for all major and critical deviations. The CAPA Form template is in [SOP-CR-026](/sops/cr-026) Appendix 2. A completed CAPA must be sent to QA at QAclinicalresearch@muhc.mcgill.ca for institutional trend tracking.
...
<Steps>
  ...
  <Step title="Identify the root cause">
    ...
    **Example:**
    ...
    The 5 Whys is one approach. For more complex deviations, a **Fishbone (Ishikawa) diagram** can map contributing factors across categories (people, process, equipment, environment), and **Failure Mode and Effects Analysis (FMEA)** can identify where processes are most vulnerable to failure.
  </Step>
...
<Tooltip tip="All planned and systematic actions to ensure trial data are generated, documented, and reported in compliance with GCP and SOPs." headline="Quality Assurance (QA)" cta="Full definition" href="/kb/glossary#qa">QA</Tooltip> reviews CAPA forms submitted across the institution for patterns. At the study level, the QI/PI and CRC should review the Deviation Log periodically for trends.
...
- [Reportable Events and Protocol Deviations](/kb/reportable-events) — classification definitions, reporting timelines, Deviation Log
...
- [Data Integrity](/kb/data-integrity) — ALCOA+ principles and documentation requirements
