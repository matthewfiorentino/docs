...
<Steps>
  <Step title="Identify your knowledge users">
    Who needs to act on this research? Clinicians, patients, health system leaders, policy-makers, professional associations? Name them specifically — not "health care providers generally" but the clinical specialty, health authority, or body that will use the findings.
  </Step>
