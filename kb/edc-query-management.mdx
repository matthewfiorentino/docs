...
For RI-MUHC-led studies using REDCap as the data management platform, see the [CORD — Research Data Management](/kb/cord) page.
...
- [CORD — Research Data Management](/kb/cord) — REDCap and data management support for RI-MUHC-led studies
